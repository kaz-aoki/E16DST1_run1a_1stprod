...
bool E16ANA_STSDeadChannel::ReadFile(const char *filename){
    Init();
...
//============================================================
bool E16ANA_STSDeadChannel::ReadDeadChannelData(const int runID){
    E16ANA_CalibDBManager &calib = E16ANA_CalibDBManager::Instance();
    std::string sts_dead_channel_file = calib.CalibFileName("STS-deadch", runID);
    this->ReadFile(sts_dead_channel_file.c_str());
    return true;
}
