...
#ifndef E16ANA_STRAIGHTSTEPTRACK_HH
#define E16ANA_STRAIGHTSTEPTRACK_HH
...
class E16ANA_StraightStepTrack {
  //unit:
private:
...
public:
  ...
  int Cross(E16ANA_StraightStepTrack& st, double* distance,double* step1, double* step2);
  //return flag;: minuit minimize status. 3 is good.
  // cross is the mid-point of the most nearest point in each two track.


  int Cross(E16ANA_StraightStepTrack& st, double* distance, Hep3Vector* point,
  ...
  int CrossXZ(E16ANA_StraightStepTrack& st, double* distance,double* step1, double* step2);
  int CrossXZ(E16ANA_StraightStepTrack& st, double* distance, Hep3Vector* point,
	       Hep3Vector* pos1, Hep3Vector* pos2, Hep3Vector* mom1, Hep3Vector* mom2) {
    double step1,step2;
...
#endif// E16ANA_STRAIGHTSTEPTRACK_HH
