#ifndef E16ANA_STRAIGHT_TRACK_CONSTANT_HH
#define E16ANA_STRAIGHT_TRACK_CONSTANT_HH

#include <array>

namespace E16ANA_StraightTrackConstant {
...
constexpr int kNumTrackingStrips = 7;//DONOT Change 
