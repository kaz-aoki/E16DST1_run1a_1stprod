...
//  std::vector<double> out_plus_proj_lg_max_adc;
  std::vector<int>    out_minus_proj_n_hbd;
  std::vector<double> out_minus_proj_hbd0_res;
  std::vector<float>  out_minus_proj_hbd0_adc;
  std::vector<float>  out_minus_proj_hbd0_t;
  std::vector<double> out_minus_proj_hbd1_res;
  std::vector<float>  out_minus_proj_hbd1_adc;
  std::vector<float>  out_minus_proj_hbd1_t;
  std::vector<double> out_minus_proj_hbd2_res;
  std::vector<float>  out_minus_proj_hbd2_adc;
  std::vector<float>  out_minus_proj_hbd2_t;
  std::vector<double> out_minus_proj_hbd3_res;
  std::vector<float>  out_minus_proj_hbd3_adc;
  std::vector<float>  out_minus_proj_hbd3_t;
  std::vector<int>    out_plus_proj_n_hbd;
  std::vector<double> out_plus_proj_hbd0_res;
  std::vector<float>  out_plus_proj_hbd0_adc;
  std::vector<float>  out_plus_proj_hbd0_t;
  std::vector<double> out_plus_proj_hbd1_res;
  std::vector<float>  out_plus_proj_hbd1_adc;
  std::vector<float>  out_plus_proj_hbd1_t;
  std::vector<double> out_plus_proj_hbd2_res;
  std::vector<float>  out_plus_proj_hbd2_adc;
  std::vector<float>  out_plus_proj_hbd2_t;
  std::vector<double> out_plus_proj_hbd3_res;
  std::vector<float>  out_plus_proj_hbd3_adc;
  std::vector<float>  out_plus_proj_hbd3_t;
  std::vector<int>    out_minus_proj_n_lg;
  std::vector<int>    out_minus_proj_lg0_fflag;
  std::vector<double> out_minus_proj_lg0_res;
  std::vector<float>  out_minus_proj_lg0_adc;
  std::vector<float>  out_minus_proj_lg0_t;
  std::vector<int>    out_minus_proj_lg1_fflag;
  std::vector<double> out_minus_proj_lg1_res;
  std::vector<float>  out_minus_proj_lg1_adc;
  std::vector<float>  out_minus_proj_lg1_t;
  std::vector<int>    out_minus_proj_lg2_fflag;
  std::vector<double> out_minus_proj_lg2_res;
  std::vector<float>  out_minus_proj_lg2_adc;
  std::vector<float>  out_minus_proj_lg2_t;
  std::vector<int>    out_minus_proj_lg3_fflag;
  std::vector<double> out_minus_proj_lg3_res;
  std::vector<float>  out_minus_proj_lg3_adc;
  std::vector<float>  out_minus_proj_lg3_t;
  std::vector<int>    out_plus_proj_n_lg;
  std::vector<int>    out_plus_proj_lg0_fflag;
  std::vector<double> out_plus_proj_lg0_res;
  std::vector<float>  out_plus_proj_lg0_adc;
  std::vector<float>  out_plus_proj_lg0_t;
  std::vector<int>    out_plus_proj_lg1_fflag;
  std::vector<double> out_plus_proj_lg1_res;
  std::vector<float>  out_plus_proj_lg1_adc;
  std::vector<float>  out_plus_proj_lg1_t;
  std::vector<int>    out_plus_proj_lg2_fflag;
  std::vector<double> out_plus_proj_lg2_res;
  std::vector<float>  out_plus_proj_lg2_adc;
  std::vector<float>  out_plus_proj_lg2_t;
  std::vector<int>    out_plus_proj_lg3_fflag;
  std::vector<double> out_plus_proj_lg3_res;
  std::vector<float>  out_plus_proj_lg3_adc;
  std::vector<float>  out_plus_proj_lg3_t;
...
//  out_tree->Branch("plus_proj_lg_max_adc",  &out_plus_proj_lg_max_adc);
  ...
  out_tree->Branch("minus_proj_hbd0_t",    &out_minus_proj_hbd0_t);
  out_tree->Branch("minus_proj_hbd1_res",  &out_minus_proj_hbd1_res);
  out_tree->Branch("minus_proj_hbd1_adc",  &out_minus_proj_hbd1_adc);
  out_tree->Branch("minus_proj_hbd1_t",    &out_minus_proj_hbd1_t);
  out_tree->Branch("minus_proj_hbd2_res",  &out_minus_proj_hbd2_res);
  out_tree->Branch("minus_proj_hbd2_adc",  &out_minus_proj_hbd2_adc);
  out_tree->Branch("minus_proj_hbd2_t",    &out_minus_proj_hbd2_t);
  out_tree->Branch("minus_proj_hbd3_res",  &out_minus_proj_hbd3_res);
  out_tree->Branch("minus_proj_hbd3_adc",  &out_minus_proj_hbd3_adc);
  out_tree->Branch("minus_proj_hbd3_t",    &out_minus_proj_hbd3_t);
  out_tree->Branch("minus_proj_n_lg",      &out_minus_proj_n_lg);
  out_tree->Branch("minus_proj_lg0_fflag", &out_minus_proj_lg0_fflag);
  out_tree->Branch("minus_proj_lg0_res",   &out_minus_proj_lg0_res);
  out_tree->Branch("minus_proj_lg0_adc",   &out_minus_proj_lg0_adc);
  out_tree->Branch("minus_proj_lg0_t",     &out_minus_proj_lg0_t);
  out_tree->Branch("minus_proj_lg1_fflag", &out_minus_proj_lg1_fflag);
  out_tree->Branch("minus_proj_lg1_res",   &out_minus_proj_lg1_res);
  out_tree->Branch("minus_proj_lg1_adc",   &out_minus_proj_lg1_adc);
  out_tree->Branch("minus_proj_lg1_t",     &out_minus_proj_lg1_t);
  out_tree->Branch("minus_proj_lg2_fflag", &out_minus_proj_lg2_fflag);
  out_tree->Branch("minus_proj_lg2_res",   &out_minus_proj_lg2_res);
  out_tree->Branch("minus_proj_lg2_adc",   &out_minus_proj_lg2_adc);
  out_tree->Branch("minus_proj_lg2_t",     &out_minus_proj_lg2_t);
  out_tree->Branch("minus_proj_lg3_fflag", &out_minus_proj_lg3_fflag);
  out_tree->Branch("minus_proj_lg3_res",   &out_minus_proj_lg3_res);
  out_tree->Branch("minus_proj_lg3_adc",   &out_minus_proj_lg3_adc);
  out_tree->Branch("minus_proj_lg3_t",     &out_minus_proj_lg3_t);
  out_tree->Branch("plus_proj_n_hbd",      &out_plus_proj_n_hbd);
  out_tree->Branch("plus_proj_hbd0_res",   &out_plus_proj_hbd0_res);
  out_tree->Branch("plus_proj_hbd0_adc",   &out_plus_proj_hbd0_adc);
  out_tree->Branch("plus_proj_hbd0_t",     &out_plus_proj_hbd0_t);
  out_tree->Branch("plus_proj_hbd1_res",   &out_plus_proj_hbd1_res);
  out_tree->Branch("plus_proj_hbd1_adc",   &out_plus_proj_hbd1_adc);
  out_tree->Branch("plus_proj_hbd1_t",     &out_plus_proj_hbd1_t);
  out_tree->Branch("plus_proj_hbd2_res",   &out_plus_proj_hbd2_res);
  out_tree->Branch("plus_proj_hbd2_adc",   &out_plus_proj_hbd2_adc);
  out_tree->Branch("plus_proj_hbd2_t",     &out_plus_proj_hbd2_t);
  out_tree->Branch("plus_proj_hbd3_res",   &out_plus_proj_hbd3_res);
  out_tree->Branch("plus_proj_hbd3_adc",   &out_plus_proj_hbd3_adc);
  out_tree->Branch("plus_proj_hbd3_t",     &out_plus_proj_hbd3_t);
  out_tree->Branch("plus_proj_n_lg",       &out_plus_proj_n_lg);
  out_tree->Branch("plus_proj_lg0_fflag",  &out_plus_proj_lg0_fflag);
  out_tree->Branch("plus_proj_lg0_res",    &out_plus_proj_lg0_res);
  out_tree->Branch("plus_proj_lg0_adc",    &out_plus_proj_lg0_adc);
  out_tree->Branch("plus_proj_lg0_t",      &out_plus_proj_lg0_t);
  out_tree->Branch("plus_proj_lg1_fflag",  &out_plus_proj_lg1_fflag);
  out_tree->Branch("plus_proj_lg1_res",    &out_plus_proj_lg1_res);
  out_tree->Branch("plus_proj_lg1_adc",    &out_plus_proj_lg1_adc);
  out_tree->Branch("plus_proj_lg1_t",      &out_plus_proj_lg1_t);
  out_tree->Branch("plus_proj_lg2_fflag",  &out_plus_proj_lg2_fflag);
  out_tree->Branch("plus_proj_lg2_res",    &out_plus_proj_lg2_res);
  out_tree->Branch("plus_proj_lg2_adc",    &out_plus_proj_lg2_adc);
  out_tree->Branch("plus_proj_lg2_t",      &out_plus_proj_lg2_t);
  out_tree->Branch("plus_proj_lg3_fflag",  &out_plus_proj_lg3_fflag);
