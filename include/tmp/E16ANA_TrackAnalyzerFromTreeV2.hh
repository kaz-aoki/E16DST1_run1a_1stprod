...
//  void InitOutTree();
  ...
  void InitOutTreeWoRefit(TTree* tree);
  void InitOutTrees();
  void ClearOutBranch();
...
//  out_file->cd();
  ...
  out_tree2 = new TTree("tree2", "tree2");
  InitOutTrees();
}
...
void E16ANA_TrackAnalyzerFromTree::InitOutTree(TTree* tree) {
  ...
  tree->Branch("timestamp_in_spill", &out_timestamp_in_spill, "timestamp_in_spill/L");
  tree->Branch("trigger_fine_time", &out_trigger_fine_time, "trigger_fine_time/I");
  ...
  tree->Branch("n_gtr100yb_clusters", out_n_gtr100yb_clusters, "n_gtr100yb_clusters[9]/I");
  tree->Branch("n_gtr200x_clusters",  out_n_gtr200x_clusters,  "n_gtr200x_clusters[9]/I");
  tree->Branch("n_gtr200y_clusters",  out_n_gtr200y_clusters,  "n_gtr200y_clusters[9]/I");
  tree->Branch("n_gtr300x_clusters",  out_n_gtr300x_clusters,  "n_gtr300x_clusters[9]/I");
  tree->Branch("n_gtr300y_clusters",  out_n_gtr300y_clusters,  "n_gtr300y_clusters[9]/I");
  tree->Branch("n_hbd_clusters",      out_n_hbd_clusters,      "n_hbd_clusters[9]/I");
  tree->Branch("n_lg_hits",           out_n_lg_hits,           "n_lg_hits[9]/I");
  tree->Branch("n_lg_clusters",       out_n_lg_clusters,       "n_lg_clusters[9]/I");
  tree->Branch("ssd_cluster_t",       &out_ssd_cluster_t);
  tree->Branch("gtr100x_cluster_t",   &out_gtr100x_cluster_t);
  tree->Branch("gtr100y_cluster_t",   &out_gtr100y_cluster_t);
  tree->Branch("gtr100yb_cluster_t",  &out_gtr100yb_cluster_t);
  tree->Branch("gtr200x_cluster_t",   &out_gtr200x_cluster_t);
  tree->Branch("gtr200y_cluster_t",   &out_gtr200y_cluster_t);
  tree->Branch("gtr300x_cluster_t",   &out_gtr300x_cluster_t);
  tree->Branch("gtr300y_cluster_t",   &out_gtr300y_cluster_t);
  tree->Branch("hbd_cluster_t",       &out_hbd_cluster_t);
  tree->Branch("lg_hit_t",            &out_lg_hit_t);
  tree->Branch("lg_cluster_t",        &out_lg_cluster_t);
  tree->Branch("trg_gtr_hit_t",       &out_trg_gtr_hit_t);
  tree->Branch("trg_hbd_hit_t",       &out_trg_hbd_hit_t);
  tree->Branch("trg_lg_hit_t",        &out_trg_lg_hit_t);
  ...
  tree->Branch("minus_pre_init_gz", &out_minus_pre_init_gz);
  tree->Branch("plus_pre_init_gz",  &out_plus_pre_init_gz);
  tree->Branch("chi_square", &out_chi_square);
  tree->Branch("vtx_gx", &out_vtx_gx);
  tree->Branch("vtx_gy", &out_vtx_gy);
  tree->Branch("vtx_gz", &out_vtx_gz);
  tree->Branch("minus_mom", &out_minus_mom);
  tree->Branch("minus_mom_gx", &out_minus_mom_gx);
  tree->Branch("minus_mom_gy", &out_minus_mom_gy);
  tree->Branch("minus_mom_gz", &out_minus_mom_gz);
  tree->Branch("plus_mom", &out_plus_mom);
  tree->Branch("plus_mom_gx", &out_plus_mom_gx);
  tree->Branch("plus_mom_gy", &out_plus_mom_gy);
  tree->Branch("plus_mom_gz", &out_plus_mom_gz);
  tree->Branch("pair_cos_theta", &out_pair_cos_theta);
  ...
  tree->Branch("minus_proj_hbd_cluster_res_x",     &out_minus_proj_hbd_cluster_res_x);
  tree->Branch("minus_proj_hbd_cluster_res_y",     &out_minus_proj_hbd_cluster_res_y);
  tree->Branch("minus_proj_hbd_cluster_adc",       &out_minus_proj_hbd_cluster_adc);
  tree->Branch("minus_proj_hbd_cluster_t",         &out_minus_proj_hbd_cluster_t);
  tree->Branch("minus_proj_hbd_cluster_ft",        &out_minus_proj_hbd_cluster_ft);
  tree->Branch("minus_proj_hbd_cluster_size",      &out_minus_proj_hbd_cluster_size);
  tree->Branch("minus_proj_hbd_cluster_eprob",     &out_minus_proj_hbd_cluster_eprob);
  ...
  tree->Branch("plus_proj_hbd_cluster_res_x",      &out_plus_proj_hbd_cluster_res_x);
  tree->Branch("plus_proj_hbd_cluster_res_y",      &out_plus_proj_hbd_cluster_res_y);
  tree->Branch("plus_proj_hbd_cluster_adc",        &out_plus_proj_hbd_cluster_adc);
  tree->Branch("plus_proj_hbd_cluster_t",          &out_plus_proj_hbd_cluster_t);
  tree->Branch("plus_proj_hbd_cluster_ft",         &out_plus_proj_hbd_cluster_ft);
  tree->Branch("plus_proj_hbd_cluster_size",       &out_plus_proj_hbd_cluster_size);
  tree->Branch("plus_proj_hbd_cluster_eprob",      &out_plus_proj_hbd_cluster_eprob);
  tree->Branch("plus_proj_hbd_cluster_cprob",      &out_plus_proj_hbd_cluster_cprob);
  ...
  tree->Branch("minus_proj_lg_hit_type",           &out_minus_proj_lg_hit_type);
  tree->Branch("minus_proj_lg_hit_res",            &out_minus_proj_lg_hit_res);
  tree->Branch("minus_proj_lg_hit_res_x",          &out_minus_proj_lg_hit_res_x);
  tree->Branch("minus_proj_lg_hit_res_y",          &out_minus_proj_lg_hit_res_y);
  tree->Branch("minus_proj_lg_hit_adc",            &out_minus_proj_lg_hit_adc);
  tree->Branch("minus_proj_lg_hit_t",              &out_minus_proj_lg_hit_t);
  tree->Branch("minus_proj_lg_hit_ise",            &out_minus_proj_lg_hit_ise);
  ...
  tree->Branch("plus_proj_lg_hit_type",            &out_plus_proj_lg_hit_type);
  tree->Branch("plus_proj_lg_hit_res",             &out_plus_proj_lg_hit_res);
  tree->Branch("plus_proj_lg_hit_res_x",           &out_plus_proj_lg_hit_res_x);
  tree->Branch("plus_proj_lg_hit_res_y",           &out_plus_proj_lg_hit_res_y);
  tree->Branch("plus_proj_lg_hit_adc",             &out_plus_proj_lg_hit_adc);
  tree->Branch("plus_proj_lg_hit_t",               &out_plus_proj_lg_hit_t);
  tree->Branch("plus_proj_lg_hit_ise",             &out_plus_proj_lg_hit_ise);
  ...
  tree->Branch("minus_proj_lg_cluster_type",       &out_minus_proj_lg_cluster_type);
  tree->Branch("minus_proj_lg_cluster_res",        &out_minus_proj_lg_cluster_res);
  tree->Branch("minus_proj_lg_cluster_res_x",      &out_minus_proj_lg_cluster_res_x);
  tree->Branch("minus_proj_lg_cluster_res_y",      &out_minus_proj_lg_cluster_res_y);
  tree->Branch("minus_proj_lg_cluster_adc",        &out_minus_proj_lg_cluster_adc);
  tree->Branch("minus_proj_lg_cluster_t",          &out_minus_proj_lg_cluster_t);
  tree->Branch("minus_proj_lg_cluster_ise",        &out_minus_proj_lg_cluster_ise);
  ...
  tree->Branch("plus_proj_lg_cluster_type",        &out_plus_proj_lg_cluster_type);
  tree->Branch("plus_proj_lg_cluster_res",         &out_plus_proj_lg_cluster_res);
  tree->Branch("plus_proj_lg_cluster_res_x",       &out_plus_proj_lg_cluster_res_x);
  tree->Branch("plus_proj_lg_cluster_res_y",       &out_plus_proj_lg_cluster_res_y);
  tree->Branch("plus_proj_lg_cluster_adc",         &out_plus_proj_lg_cluster_adc);
  tree->Branch("plus_proj_lg_cluster_t",           &out_plus_proj_lg_cluster_t);
  ...
  tree->Branch("minus_proj_trg_lg_hit_type",       &out_minus_proj_trg_lg_hit_type);
  tree->Branch("minus_proj_trg_lg_hit_res",        &out_minus_proj_trg_lg_hit_res);
  tree->Branch("minus_proj_trg_lg_hit_res_x",      &out_minus_proj_trg_lg_hit_res_x);
  tree->Branch("minus_proj_trg_lg_hit_res_y",      &out_minus_proj_trg_lg_hit_res_y);
  ...
  tree->Branch("plus_proj_trg_lg_hit_type",        &out_plus_proj_trg_lg_hit_type);
  tree->Branch("plus_proj_trg_lg_hit_res",         &out_plus_proj_trg_lg_hit_res);
  tree->Branch("plus_proj_trg_lg_hit_res_x",       &out_plus_proj_trg_lg_hit_res_x);
  tree->Branch("plus_proj_trg_lg_hit_res_y",       &out_plus_proj_trg_lg_hit_res_y);
  tree->Branch("plus_proj_trg_lg_hit_t",           &out_plus_proj_trg_lg_hit_t);
  ...
  tree->Branch("minus_ssd_hit_gx",        &out_minus_ssd_hit_gx);
  tree->Branch("minus_ssd_hit_gy",        &out_minus_ssd_hit_gy);
  tree->Branch("minus_ssd_hit_gz",        &out_minus_ssd_hit_gz);
  tree->Branch("minus_ssd_hit_t",         &out_minus_ssd_hit_t);
  tree->Branch("minus_ssd_hit_adc",       &out_minus_ssd_hit_adc);
  tree->Branch("minus_gtr100_hit_x",      &out_minus_gtr100_hit_x);
  tree->Branch("minus_gtr100_hit_y",      &out_minus_gtr100_hit_y);
  tree->Branch("minus_gtr100_hit_z",      &out_minus_gtr100_hit_z);
  tree->Branch("minus_gtr100_hit_gx",     &out_minus_gtr100_hit_gx);
  tree->Branch("minus_gtr100_hit_gy",     &out_minus_gtr100_hit_gy);
  tree->Branch("minus_gtr100_hit_gz",     &out_minus_gtr100_hit_gz);
  tree->Branch("minus_gtr100_hit_xt",     &out_minus_gtr100_hit_xt);
  tree->Branch("minus_gtr100_hit_yt",     &out_minus_gtr100_hit_yt);
  tree->Branch("minus_gtr100_hit_xadc",   &out_minus_gtr100_hit_xadc);
  tree->Branch("minus_gtr100_hit_yadc",   &out_minus_gtr100_hit_yadc);
  tree->Branch("minus_gtr200_hit_x",      &out_minus_gtr200_hit_x);
  tree->Branch("minus_gtr200_hit_y",      &out_minus_gtr200_hit_y);
  tree->Branch("minus_gtr200_hit_z",      &out_minus_gtr200_hit_z);
  tree->Branch("minus_gtr200_hit_gx",     &out_minus_gtr200_hit_gx);
  tree->Branch("minus_gtr200_hit_gy",     &out_minus_gtr200_hit_gy);
  tree->Branch("minus_gtr200_hit_gz",     &out_minus_gtr200_hit_gz);
  tree->Branch("minus_gtr200_hit_xt",     &out_minus_gtr200_hit_xt);
  tree->Branch("minus_gtr200_hit_yt",     &out_minus_gtr200_hit_yt);
  tree->Branch("minus_gtr200_hit_xadc",   &out_minus_gtr200_hit_xadc);
  tree->Branch("minus_gtr200_hit_yadc",   &out_minus_gtr200_hit_yadc);
  tree->Branch("minus_gtr300_hit_x",      &out_minus_gtr300_hit_x);
  tree->Branch("minus_gtr300_hit_y",      &out_minus_gtr300_hit_y);
  tree->Branch("minus_gtr300_hit_z",      &out_minus_gtr300_hit_z);
  tree->Branch("minus_gtr300_hit_gx",     &out_minus_gtr300_hit_gx);
  tree->Branch("minus_gtr300_hit_gy",     &out_minus_gtr300_hit_gy);
  tree->Branch("minus_gtr300_hit_gz",     &out_minus_gtr300_hit_gz);
  tree->Branch("minus_gtr300_hit_xt",     &out_minus_gtr300_hit_xt);
  tree->Branch("minus_gtr300_hit_yt",     &out_minus_gtr300_hit_yt);
  tree->Branch("minus_gtr300_hit_xadc",   &out_minus_gtr300_hit_xadc);
  tree->Branch("minus_gtr300_hit_yadc",   &out_minus_gtr300_hit_yadc);
  tree->Branch("plus_ssd_hit_x",          &out_plus_ssd_hit_x);
  tree->Branch("plus_ssd_hit_y",          &out_plus_ssd_hit_y);
  tree->Branch("plus_ssd_hit_z",          &out_plus_ssd_hit_z);
  tree->Branch("plus_ssd_hit_gx",         &out_plus_ssd_hit_gx);
  tree->Branch("plus_ssd_hit_gy",         &out_plus_ssd_hit_gy);
  tree->Branch("plus_ssd_hit_gz",         &out_plus_ssd_hit_gz);
  tree->Branch("plus_ssd_hit_t",          &out_plus_ssd_hit_t);
  tree->Branch("plus_ssd_hit_adc",        &out_plus_ssd_hit_adc);
  tree->Branch("plus_gtr100_hit_x",       &out_plus_gtr100_hit_x);
  tree->Branch("plus_gtr100_hit_y",       &out_plus_gtr100_hit_y);
  tree->Branch("plus_gtr100_hit_z",       &out_plus_gtr100_hit_z);
  tree->Branch("plus_gtr100_hit_gx",      &out_plus_gtr100_hit_gx);
  tree->Branch("plus_gtr100_hit_gy",      &out_plus_gtr100_hit_gy);
  tree->Branch("plus_gtr100_hit_gz",      &out_plus_gtr100_hit_gz);
  tree->Branch("plus_gtr100_hit_xt",      &out_plus_gtr100_hit_xt);
  tree->Branch("plus_gtr100_hit_yt",      &out_plus_gtr100_hit_yt);
  tree->Branch("plus_gtr100_hit_xadc",    &out_plus_gtr100_hit_xadc);
  tree->Branch("plus_gtr100_hit_yadc",    &out_plus_gtr100_hit_yadc);
  tree->Branch("plus_gtr200_hit_x",       &out_plus_gtr200_hit_x);
  tree->Branch("plus_gtr200_hit_y",       &out_plus_gtr200_hit_y);
  tree->Branch("plus_gtr200_hit_z",       &out_plus_gtr200_hit_z);
  tree->Branch("plus_gtr200_hit_gx",      &out_plus_gtr200_hit_gx);
  tree->Branch("plus_gtr200_hit_gy",      &out_plus_gtr200_hit_gy);
  tree->Branch("plus_gtr200_hit_gz",      &out_plus_gtr200_hit_gz);
  tree->Branch("plus_gtr200_hit_xt",      &out_plus_gtr200_hit_xt);
  tree->Branch("plus_gtr200_hit_yt",      &out_plus_gtr200_hit_yt);
  tree->Branch("plus_gtr200_hit_xadc",    &out_plus_gtr200_hit_xadc);
  tree->Branch("plus_gtr200_hit_yadc",    &out_plus_gtr200_hit_yadc);
  tree->Branch("plus_gtr300_hit_x",       &out_plus_gtr300_hit_x);
  tree->Branch("plus_gtr300_hit_y",       &out_plus_gtr300_hit_y);
  tree->Branch("plus_gtr300_hit_z",       &out_plus_gtr300_hit_z);
  tree->Branch("plus_gtr300_hit_gx",      &out_plus_gtr300_hit_gx);
  tree->Branch("plus_gtr300_hit_gy",      &out_plus_gtr300_hit_gy);
  tree->Branch("plus_gtr300_hit_gz",      &out_plus_gtr300_hit_gz);
  tree->Branch("plus_gtr300_hit_xt",      &out_plus_gtr300_hit_xt);
  tree->Branch("plus_gtr300_hit_yt",      &out_plus_gtr300_hit_yt);
  tree->Branch("plus_gtr300_hit_xadc",    &out_plus_gtr300_hit_xadc);
  tree->Branch("plus_gtr300_hit_yadc",    &out_plus_gtr300_hit_yadc);
  
  tree->Branch("minus_ssd_fit_x",     &out_minus_ssd_fit_x);
  tree->Branch("minus_ssd_fit_y",     &out_minus_ssd_fit_y);
  tree->Branch("minus_ssd_fit_z",     &out_minus_ssd_fit_z);
  tree->Branch("minus_gtr100_fit_x",  &out_minus_gtr100_fit_x);
  tree->Branch("minus_gtr100_fit_y",  &out_minus_gtr100_fit_y);
  tree->Branch("minus_gtr100_fit_z",  &out_minus_gtr100_fit_z);
  tree->Branch("minus_gtr200_fit_x",  &out_minus_gtr200_fit_x);
  tree->Branch("minus_gtr200_fit_y",  &out_minus_gtr200_fit_y);
  tree->Branch("minus_gtr200_fit_z",  &out_minus_gtr200_fit_z);
  tree->Branch("minus_gtr300_fit_x",  &out_minus_gtr300_fit_x);
  tree->Branch("minus_gtr300_fit_y",  &out_minus_gtr300_fit_y);
  tree->Branch("minus_gtr300_fit_z",  &out_minus_gtr300_fit_z);
  tree->Branch("minus_hbd_fit_x",     &out_minus_hbd_fit_x);
  tree->Branch("minus_hbd_fit_y",     &out_minus_hbd_fit_y);
  tree->Branch("minus_hbd_fit_z",     &out_minus_hbd_fit_z);
  tree->Branch("minus_lg_c_fit_x",    &out_minus_lg_c_fit_x);
  tree->Branch("minus_lg_c_fit_y",    &out_minus_lg_c_fit_y);
  tree->Branch("minus_lg_c_fit_z",    &out_minus_lg_c_fit_z);
  tree->Branch("minus_lg_b_fit_x",    &out_minus_lg_b_fit_x);
  tree->Branch("minus_lg_b_fit_y",    &out_minus_lg_b_fit_y);
  tree->Branch("minus_lg_b_fit_z",    &out_minus_lg_b_fit_z);
  tree->Branch("minus_lg_a_fit_x",    &out_minus_lg_a_fit_x);
  tree->Branch("minus_lg_a_fit_y",    &out_minus_lg_a_fit_y);
  tree->Branch("minus_lg_a_fit_z",    &out_minus_lg_a_fit_z);
  tree->Branch("plus_ssd_fit_x",      &out_plus_ssd_fit_x);
  tree->Branch("plus_ssd_fit_y",      &out_plus_ssd_fit_y);
  tree->Branch("plus_ssd_fit_z",      &out_plus_ssd_fit_z);
  tree->Branch("plus_gtr100_fit_x",   &out_plus_gtr100_fit_x);
  tree->Branch("plus_gtr100_fit_y",   &out_plus_gtr100_fit_y);
  tree->Branch("plus_gtr100_fit_z",   &out_plus_gtr100_fit_z);
  tree->Branch("plus_gtr200_fit_x",   &out_plus_gtr200_fit_x);
  tree->Branch("plus_gtr200_fit_y",   &out_plus_gtr200_fit_y);
  tree->Branch("plus_gtr200_fit_z",   &out_plus_gtr200_fit_z);
  tree->Branch("plus_gtr300_fit_x",   &out_plus_gtr300_fit_x);
  tree->Branch("plus_gtr300_fit_y",   &out_plus_gtr300_fit_y);
  tree->Branch("plus_gtr300_fit_z",   &out_plus_gtr300_fit_z);
  tree->Branch("plus_hbd_fit_x",      &out_plus_hbd_fit_x);
  tree->Branch("plus_hbd_fit_y",      &out_plus_hbd_fit_y);
  tree->Branch("plus_hbd_fit_z",      &out_plus_hbd_fit_z);
  tree->Branch("plus_lg_c_fit_x",     &out_plus_lg_c_fit_x);
  tree->Branch("plus_lg_c_fit_y",     &out_plus_lg_c_fit_y);
  tree->Branch("plus_lg_c_fit_z",     &out_plus_lg_c_fit_z);
  tree->Branch("plus_lg_b_fit_x",     &out_plus_lg_b_fit_x);
  tree->Branch("plus_lg_b_fit_y",     &out_plus_lg_b_fit_y);
  tree->Branch("plus_lg_b_fit_z",     &out_plus_lg_b_fit_z);
  tree->Branch("plus_lg_a_fit_x",     &out_plus_lg_a_fit_x);
  tree->Branch("plus_lg_a_fit_y",     &out_plus_lg_a_fit_y);
  tree->Branch("plus_lg_a_fit_z",     &out_plus_lg_a_fit_z);
  tree->Branch("minus_ssd_fit_gx",    &out_minus_ssd_fit_gx);
  tree->Branch("minus_ssd_fit_gy",    &out_minus_ssd_fit_gy);
  tree->Branch("minus_ssd_fit_gz",    &out_minus_ssd_fit_gz);
  tree->Branch("minus_gtr100_fit_gx", &out_minus_gtr100_fit_gx);
  tree->Branch("minus_gtr100_fit_gy", &out_minus_gtr100_fit_gy);
  tree->Branch("minus_gtr100_fit_gz", &out_minus_gtr100_fit_gz);
  tree->Branch("minus_gtr200_fit_gx", &out_minus_gtr200_fit_gx);
  tree->Branch("minus_gtr200_fit_gy", &out_minus_gtr200_fit_gy);
  tree->Branch("minus_gtr200_fit_gz", &out_minus_gtr200_fit_gz);
  tree->Branch("minus_gtr300_fit_gx", &out_minus_gtr300_fit_gx);
  tree->Branch("minus_gtr300_fit_gy", &out_minus_gtr300_fit_gy);
  tree->Branch("minus_gtr300_fit_gz", &out_minus_gtr300_fit_gz);
  tree->Branch("minus_hbd_fit_gx",    &out_minus_hbd_fit_gx);
  tree->Branch("minus_hbd_fit_gy",    &out_minus_hbd_fit_gy);
  tree->Branch("minus_hbd_fit_gz",    &out_minus_hbd_fit_gz);
  tree->Branch("minus_lg_c_fit_gx",   &out_minus_lg_c_fit_gx);
  tree->Branch("minus_lg_c_fit_gy",   &out_minus_lg_c_fit_gy);
  tree->Branch("minus_lg_c_fit_gz",   &out_minus_lg_c_fit_gz);
  tree->Branch("minus_lg_b_fit_gx",   &out_minus_lg_b_fit_gx);
  tree->Branch("minus_lg_b_fit_gy",   &out_minus_lg_b_fit_gy);
  tree->Branch("minus_lg_b_fit_gz",   &out_minus_lg_b_fit_gz);
  tree->Branch("minus_lg_a_fit_gx",   &out_minus_lg_a_fit_gx);
  tree->Branch("minus_lg_a_fit_gy",   &out_minus_lg_a_fit_gy);
  tree->Branch("minus_lg_a_fit_gz",   &out_minus_lg_a_fit_gz);
  tree->Branch("plus_ssd_fit_gx",     &out_plus_ssd_fit_gx);
  tree->Branch("plus_ssd_fit_gy",     &out_plus_ssd_fit_gy);
  tree->Branch("plus_ssd_fit_gz",     &out_plus_ssd_fit_gz);
  tree->Branch("plus_gtr100_fit_gx",  &out_plus_gtr100_fit_gx);
  tree->Branch("plus_gtr100_fit_gy",  &out_plus_gtr100_fit_gy);
  tree->Branch("plus_gtr100_fit_gz",  &out_plus_gtr100_fit_gz);
  tree->Branch("plus_gtr200_fit_gx",  &out_plus_gtr200_fit_gx);
  tree->Branch("plus_gtr200_fit_gy",  &out_plus_gtr200_fit_gy);
  tree->Branch("plus_gtr200_fit_gz",  &out_plus_gtr200_fit_gz);
  tree->Branch("plus_gtr300_fit_gx",  &out_plus_gtr300_fit_gx);
  tree->Branch("plus_gtr300_fit_gy",  &out_plus_gtr300_fit_gy);
  tree->Branch("plus_gtr300_fit_gz",  &out_plus_gtr300_fit_gz);
  tree->Branch("plus_hbd_fit_gx",     &out_plus_hbd_fit_gx);
  tree->Branch("plus_hbd_fit_gy",     &out_plus_hbd_fit_gy);
  tree->Branch("plus_hbd_fit_gz",     &out_plus_hbd_fit_gz);
  tree->Branch("plus_lg_c_fit_gx",    &out_plus_lg_c_fit_gx);
  tree->Branch("plus_lg_c_fit_gy",    &out_plus_lg_c_fit_gy);
  tree->Branch("plus_lg_c_fit_gz",    &out_plus_lg_c_fit_gz);
  tree->Branch("plus_lg_b_fit_gx",    &out_plus_lg_b_fit_gx);
  tree->Branch("plus_lg_b_fit_gy",    &out_plus_lg_b_fit_gy);
  tree->Branch("plus_lg_b_fit_gz",    &out_plus_lg_b_fit_gz);
  tree->Branch("plus_lg_a_fit_gx",    &out_plus_lg_a_fit_gx);
  tree->Branch("plus_lg_a_fit_gy",    &out_plus_lg_a_fit_gy);
  tree->Branch("plus_lg_a_fit_gz",    &out_plus_lg_a_fit_gz);
  
  tree->Branch("minus_ssd_fit_mom_x",      &out_minus_ssd_fit_mom_x);
  tree->Branch("minus_ssd_fit_mom_y",      &out_minus_ssd_fit_mom_y);
  tree->Branch("minus_ssd_fit_mom_z",      &out_minus_ssd_fit_mom_z);
  tree->Branch("minus_ssd_fit_mom_tan",    &out_minus_ssd_fit_mom_tan);
  tree->Branch("minus_ssd_fit_mom_gx",     &out_minus_ssd_fit_mom_gx);
  tree->Branch("minus_ssd_fit_mom_gy",     &out_minus_ssd_fit_mom_gy);
  tree->Branch("minus_ssd_fit_mom_gz",     &out_minus_ssd_fit_mom_gz);
  tree->Branch("minus_gtr100_fit_mom_x",   &out_minus_gtr100_fit_mom_x);
  tree->Branch("minus_gtr100_fit_mom_y",   &out_minus_gtr100_fit_mom_y);
  tree->Branch("minus_gtr100_fit_mom_z",   &out_minus_gtr100_fit_mom_z);
  tree->Branch("minus_gtr100_fit_mom_tan", &out_minus_gtr100_fit_mom_tan);
  tree->Branch("minus_gtr100_fit_mom_gx",  &out_minus_gtr100_fit_mom_gx);
  tree->Branch("minus_gtr100_fit_mom_gy",  &out_minus_gtr100_fit_mom_gy);
  tree->Branch("minus_gtr100_fit_mom_gz",  &out_minus_gtr100_fit_mom_gz);
  tree->Branch("minus_gtr200_fit_mom_x",   &out_minus_gtr200_fit_mom_x);
  tree->Branch("minus_gtr200_fit_mom_y",   &out_minus_gtr200_fit_mom_y);
  tree->Branch("minus_gtr200_fit_mom_z",   &out_minus_gtr200_fit_mom_z);
  tree->Branch("minus_gtr200_fit_mom_tan", &out_minus_gtr200_fit_mom_tan);
  tree->Branch("minus_gtr200_fit_mom_gx",  &out_minus_gtr200_fit_mom_gx);
  tree->Branch("minus_gtr200_fit_mom_gy",  &out_minus_gtr200_fit_mom_gy);
  tree->Branch("minus_gtr200_fit_mom_gz",  &out_minus_gtr200_fit_mom_gz);
  tree->Branch("minus_gtr300_fit_mom_x",   &out_minus_gtr300_fit_mom_x);
  tree->Branch("minus_gtr300_fit_mom_y",   &out_minus_gtr300_fit_mom_y);
  tree->Branch("minus_gtr300_fit_mom_z",   &out_minus_gtr300_fit_mom_z);
  tree->Branch("minus_gtr300_fit_mom_tan", &out_minus_gtr300_fit_mom_tan);
  tree->Branch("minus_gtr300_fit_mom_gx",  &out_minus_gtr300_fit_mom_gx);
  tree->Branch("minus_gtr300_fit_mom_gy",  &out_minus_gtr300_fit_mom_gy);
  tree->Branch("minus_gtr300_fit_mom_gz",  &out_minus_gtr300_fit_mom_gz);
  tree->Branch("minus_hbd_fit_mom_x",      &out_minus_hbd_fit_mom_x);
  tree->Branch("minus_hbd_fit_mom_y",      &out_minus_hbd_fit_mom_y);
  tree->Branch("minus_hbd_fit_mom_z",      &out_minus_hbd_fit_mom_z);
  tree->Branch("minus_hbd_fit_mom_tan",    &out_minus_hbd_fit_mom_tan);
  tree->Branch("minus_hbd_fit_mom_gx",     &out_minus_hbd_fit_mom_gx);
  tree->Branch("minus_hbd_fit_mom_gy",     &out_minus_hbd_fit_mom_gy);
  tree->Branch("minus_hbd_fit_mom_gz",     &out_minus_hbd_fit_mom_gz);
  tree->Branch("minus_lg_c_fit_mom_x",     &out_minus_lg_c_fit_mom_x);
  tree->Branch("minus_lg_c_fit_mom_y",     &out_minus_lg_c_fit_mom_y);
  tree->Branch("minus_lg_c_fit_mom_z",     &out_minus_lg_c_fit_mom_z);
  tree->Branch("minus_lg_c_fit_mom_tan",   &out_minus_lg_c_fit_mom_tan);
  tree->Branch("minus_lg_c_fit_mom_gx",    &out_minus_lg_c_fit_mom_gx);
  tree->Branch("minus_lg_c_fit_mom_gy",    &out_minus_lg_c_fit_mom_gy);
  tree->Branch("minus_lg_c_fit_mom_gz",    &out_minus_lg_c_fit_mom_gz);
  tree->Branch("minus_lg_b_fit_mom_x",     &out_minus_lg_b_fit_mom_x);
  tree->Branch("minus_lg_b_fit_mom_y",     &out_minus_lg_b_fit_mom_y);
  tree->Branch("minus_lg_b_fit_mom_z",     &out_minus_lg_b_fit_mom_z);
  tree->Branch("minus_lg_b_fit_mom_tan",   &out_minus_lg_b_fit_mom_tan);
  tree->Branch("minus_lg_b_fit_mom_gx",    &out_minus_lg_b_fit_mom_gx);
  tree->Branch("minus_lg_b_fit_mom_gy",    &out_minus_lg_b_fit_mom_gy);
  tree->Branch("minus_lg_b_fit_mom_gz",    &out_minus_lg_b_fit_mom_gz);
  tree->Branch("minus_lg_a_fit_mom_x",     &out_minus_lg_a_fit_mom_x);
  tree->Branch("minus_lg_a_fit_mom_y",     &out_minus_lg_a_fit_mom_y);
  tree->Branch("minus_lg_a_fit_mom_z",     &out_minus_lg_a_fit_mom_z);
  tree->Branch("minus_lg_a_fit_mom_tan",   &out_minus_lg_a_fit_mom_tan);
  tree->Branch("minus_lg_a_fit_mom_gx",    &out_minus_lg_a_fit_mom_gx);
  tree->Branch("minus_lg_a_fit_mom_gy",    &out_minus_lg_a_fit_mom_gy);
  tree->Branch("minus_lg_a_fit_mom_gz",    &out_minus_lg_a_fit_mom_gz);
  tree->Branch("plus_ssd_fit_mom_x",       &out_plus_ssd_fit_mom_x);
  tree->Branch("plus_ssd_fit_mom_y",       &out_plus_ssd_fit_mom_y);
  tree->Branch("plus_ssd_fit_mom_z",       &out_plus_ssd_fit_mom_z);
  tree->Branch("plus_ssd_fit_mom_tan",     &out_plus_ssd_fit_mom_tan);
  tree->Branch("plus_ssd_fit_mom_gx",      &out_plus_ssd_fit_mom_gx);
  tree->Branch("plus_ssd_fit_mom_gy",      &out_plus_ssd_fit_mom_gy);
  tree->Branch("plus_ssd_fit_mom_gz",      &out_plus_ssd_fit_mom_gz);
  tree->Branch("plus_gtr100_fit_mom_x",    &out_plus_gtr100_fit_mom_x);
  tree->Branch("plus_gtr100_fit_mom_y",    &out_plus_gtr100_fit_mom_y);
  tree->Branch("plus_gtr100_fit_mom_z",    &out_plus_gtr100_fit_mom_z);
  tree->Branch("plus_gtr100_fit_mom_tan",  &out_plus_gtr100_fit_mom_tan);
  tree->Branch("plus_gtr100_fit_mom_gx",   &out_plus_gtr100_fit_mom_gx);
  tree->Branch("plus_gtr100_fit_mom_gy",   &out_plus_gtr100_fit_mom_gy);
  tree->Branch("plus_gtr100_fit_mom_gz",   &out_plus_gtr100_fit_mom_gz);
  tree->Branch("plus_gtr200_fit_mom_x",    &out_plus_gtr200_fit_mom_x);
  tree->Branch("plus_gtr200_fit_mom_y",    &out_plus_gtr200_fit_mom_y);
  tree->Branch("plus_gtr200_fit_mom_z",    &out_plus_gtr200_fit_mom_z);
  tree->Branch("plus_gtr200_fit_mom_tan",  &out_plus_gtr200_fit_mom_tan);
  tree->Branch("plus_gtr200_fit_mom_gx",   &out_plus_gtr200_fit_mom_gx);
  tree->Branch("plus_gtr200_fit_mom_gy",   &out_plus_gtr200_fit_mom_gy);
  tree->Branch("plus_gtr200_fit_mom_gz",   &out_plus_gtr200_fit_mom_gz);
  tree->Branch("plus_gtr300_fit_mom_x",    &out_plus_gtr300_fit_mom_x);
  tree->Branch("plus_gtr300_fit_mom_y",    &out_plus_gtr300_fit_mom_y);
  tree->Branch("plus_gtr300_fit_mom_z",    &out_plus_gtr300_fit_mom_z);
  tree->Branch("plus_gtr300_fit_mom_tan",  &out_plus_gtr300_fit_mom_tan);
  tree->Branch("plus_gtr300_fit_mom_gx",   &out_plus_gtr300_fit_mom_gx);
  tree->Branch("plus_gtr300_fit_mom_gy",   &out_plus_gtr300_fit_mom_gy);
  tree->Branch("plus_gtr300_fit_mom_gz",   &out_plus_gtr300_fit_mom_gz);
  tree->Branch("plus_hbd_fit_mom_x",       &out_plus_hbd_fit_mom_x);
  tree->Branch("plus_hbd_fit_mom_y",       &out_plus_hbd_fit_mom_y);
  tree->Branch("plus_hbd_fit_mom_z",       &out_plus_hbd_fit_mom_z);
  tree->Branch("plus_hbd_fit_mom_tan",     &out_plus_hbd_fit_mom_tan);
  tree->Branch("plus_hbd_fit_mom_gx",      &out_plus_hbd_fit_mom_gx);
  tree->Branch("plus_hbd_fit_mom_gy",      &out_plus_hbd_fit_mom_gy);
  tree->Branch("plus_hbd_fit_mom_gz",      &out_plus_hbd_fit_mom_gz);
  tree->Branch("plus_lg_c_fit_mom_x",      &out_plus_lg_c_fit_mom_x);
  tree->Branch("plus_lg_c_fit_mom_y",      &out_plus_lg_c_fit_mom_y);
  tree->Branch("plus_lg_c_fit_mom_z",      &out_plus_lg_c_fit_mom_z);
  tree->Branch("plus_lg_c_fit_mom_tan",    &out_plus_lg_c_fit_mom_tan);
  tree->Branch("plus_lg_c_fit_mom_gx",     &out_plus_lg_c_fit_mom_gx);
  tree->Branch("plus_lg_c_fit_mom_gy",     &out_plus_lg_c_fit_mom_gy);
  tree->Branch("plus_lg_c_fit_mom_gz",     &out_plus_lg_c_fit_mom_gz);
  tree->Branch("plus_lg_b_fit_mom_x",      &out_plus_lg_b_fit_mom_x);
  tree->Branch("plus_lg_b_fit_mom_y",      &out_plus_lg_b_fit_mom_y);
  tree->Branch("plus_lg_b_fit_mom_z",      &out_plus_lg_b_fit_mom_z);
  tree->Branch("plus_lg_b_fit_mom_tan",    &out_plus_lg_b_fit_mom_tan);
  tree->Branch("plus_lg_b_fit_mom_gx",     &out_plus_lg_b_fit_mom_gx);
  tree->Branch("plus_lg_b_fit_mom_gy",     &out_plus_lg_b_fit_mom_gy);
  tree->Branch("plus_lg_b_fit_mom_gz",     &out_plus_lg_b_fit_mom_gz);
  tree->Branch("plus_lg_a_fit_mom_x",      &out_plus_lg_a_fit_mom_x);
  tree->Branch("plus_lg_a_fit_mom_y",      &out_plus_lg_a_fit_mom_y);
  tree->Branch("plus_lg_a_fit_mom_z",      &out_plus_lg_a_fit_mom_z);
  tree->Branch("plus_lg_a_fit_mom_tan",    &out_plus_lg_a_fit_mom_tan);
  tree->Branch("plus_lg_a_fit_mom_gx",     &out_plus_lg_a_fit_mom_gx);
  tree->Branch("plus_lg_a_fit_mom_gy",     &out_plus_lg_a_fit_mom_gy);
  tree->Branch("plus_lg_a_fit_mom_gz",     &out_plus_lg_a_fit_mom_gz);
  
  tree->Branch("minus_ssd_res",      &out_minus_ssd_res);
  tree->Branch("minus_ssd_res_x",    &out_minus_ssd_res_x);
  tree->Branch("minus_ssd_res_y",    &out_minus_ssd_res_y);
  tree->Branch("minus_ssd_res_z",    &out_minus_ssd_res_z);
  tree->Branch("minus_gtr100_res_x", &out_minus_gtr100_res_x);
  tree->Branch("minus_gtr100_res_y", &out_minus_gtr100_res_y);
  tree->Branch("minus_gtr100_res_z", &out_minus_gtr100_res_z);
  tree->Branch("minus_gtr100_res",   &out_minus_gtr100_res);
  tree->Branch("minus_gtr200_res",   &out_minus_gtr200_res);
  tree->Branch("minus_gtr200_res_x", &out_minus_gtr200_res_x);
  tree->Branch("minus_gtr200_res_y", &out_minus_gtr200_res_y);
  tree->Branch("minus_gtr200_res_z", &out_minus_gtr200_res_z);
  tree->Branch("minus_gtr300_res",   &out_minus_gtr300_res);
  tree->Branch("minus_gtr300_res_x", &out_minus_gtr300_res_x);
  tree->Branch("minus_gtr300_res_y", &out_minus_gtr300_res_y);
  tree->Branch("minus_gtr300_res_z", &out_minus_gtr300_res_z);
  tree->Branch("plus_ssd_res",       &out_plus_ssd_res);
  tree->Branch("plus_ssd_res_x",     &out_plus_ssd_res_x);
  tree->Branch("plus_ssd_res_y",     &out_plus_ssd_res_y);
  tree->Branch("plus_ssd_res_z",     &out_plus_ssd_res_z);
  tree->Branch("plus_gtr100_res",    &out_plus_gtr100_res);
  tree->Branch("plus_gtr100_res_x",  &out_plus_gtr100_res_x);
  tree->Branch("plus_gtr100_res_y",  &out_plus_gtr100_res_y);
  tree->Branch("plus_gtr100_res_z",  &out_plus_gtr100_res_z);
  tree->Branch("plus_gtr200_res",    &out_plus_gtr200_res);
  tree->Branch("plus_gtr200_res_x",  &out_plus_gtr200_res_x);
  tree->Branch("plus_gtr200_res_y",  &out_plus_gtr200_res_y);
  tree->Branch("plus_gtr200_res_z",  &out_plus_gtr200_res_z);
  tree->Branch("plus_gtr300_res",    &out_plus_gtr300_res);
  tree->Branch("plus_gtr300_res_x",  &out_plus_gtr300_res_x);
  tree->Branch("plus_gtr300_res_y",  &out_plus_gtr300_res_y);
  tree->Branch("plus_gtr300_res_z",  &out_plus_gtr300_res_z);
  ...
  tree->Branch("ks_pos_at_x0_gx", &out_ks_pos_at_x0_gx);
  tree->Branch("ks_pos_at_x0_gy", &out_ks_pos_at_x0_gy);
  tree->Branch("ks_pos_at_x0_gz", &out_ks_pos_at_x0_gz);
  tree->Branch("ks_mom_at_x0_gx", &out_ks_mom_at_x0_gx);
  tree->Branch("ks_mom_at_x0_gy", &out_ks_mom_at_x0_gy);
  tree->Branch("ks_mom_at_x0_gz", &out_ks_mom_at_x0_gz);
  tree->Branch("ks_t_at_x0",      &out_ks_t_at_x0);
}

void E16ANA_TrackAnalyzerFromTree::InitOutTreeWoRefit(TTree* tree) {
  tree->Branch("run_id", &out_run_id, "run_id/I");
  tree->Branch("event_id", &out_event_id, "event_id/I");
  tree->Branch("spill_id", &out_spill_id, "spill_id/I");
  tree->Branch("timestamp_in_spill", &out_timestamp_in_spill, "timestamp_in_spill/L");
  ...
  tree->Branch("minus_chi_square", &out_minus_chi_square);
  tree->Branch("plus_chi_square", &out_plus_chi_square);
...
void E16ANA_TrackAnalyzerFromTree::InitOutTrees() {
  InitOutTree(out_tree);
  InitOutTree(out_tree1);
  InitOutTreeWoRefit(out_tree2);
  return;
}
