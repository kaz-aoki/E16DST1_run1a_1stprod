...
class E16ANA_TrackCheckFile {
 public:
  E16ANA_TrackCheckFile(char* file_name = "tmp.root", int _run_id = E16DST_DST1Constant::kInvalidValue)
    ...
    tree->Branch("rk_pair_minus_ssd_res_refit_gx", &rk_pair_minus_ssd_res_refit_gx);
    tree->Branch("rk_pair_minus_ssd_res_refit_gy", &rk_pair_minus_ssd_res_refit_gy);
    tree->Branch("rk_pair_minus_ssd_res_refit_gz", &rk_pair_minus_ssd_res_refit_gz);
    tree->Branch("rk_pair_minus_gtr100_res_refit_gx", &rk_pair_minus_gtr100_res_refit_gx);
    tree->Branch("rk_pair_minus_gtr100_res_refit_gy", &rk_pair_minus_gtr100_res_refit_gy);
    tree->Branch("rk_pair_minus_gtr100_res_refit_gz", &rk_pair_minus_gtr100_res_refit_gz);
    tree->Branch("rk_pair_minus_gtr200_res_refit_gx", &rk_pair_minus_gtr200_res_refit_gx);
    tree->Branch("rk_pair_minus_gtr200_res_refit_gy", &rk_pair_minus_gtr200_res_refit_gy);
    tree->Branch("rk_pair_minus_gtr200_res_refit_gz", &rk_pair_minus_gtr200_res_refit_gz);
    tree->Branch("rk_pair_minus_gtr300_res_refit_gx", &rk_pair_minus_gtr300_res_refit_gx);
    tree->Branch("rk_pair_minus_gtr300_res_refit_gy", &rk_pair_minus_gtr300_res_refit_gy);
    tree->Branch("rk_pair_minus_gtr300_res_refit_gz", &rk_pair_minus_gtr300_res_refit_gz);
    tree->Branch("rk_pair_plus_ssd_res_refit_gx", &rk_pair_plus_ssd_res_refit_gx);
    tree->Branch("rk_pair_plus_ssd_res_refit_gy", &rk_pair_plus_ssd_res_refit_gy);
    tree->Branch("rk_pair_plus_ssd_res_refit_gz", &rk_pair_plus_ssd_res_refit_gz);
    tree->Branch("rk_pair_plus_gtr100_res_refit_gx", &rk_pair_plus_gtr100_res_refit_gx);
    tree->Branch("rk_pair_plus_gtr100_res_refit_gy", &rk_pair_plus_gtr100_res_refit_gy);
    tree->Branch("rk_pair_plus_gtr100_res_refit_gz", &rk_pair_plus_gtr100_res_refit_gz);
    tree->Branch("rk_pair_plus_gtr200_res_refit_gx", &rk_pair_plus_gtr200_res_refit_gx);
    tree->Branch("rk_pair_plus_gtr200_res_refit_gy", &rk_pair_plus_gtr200_res_refit_gy);
    tree->Branch("rk_pair_plus_gtr200_res_refit_gz", &rk_pair_plus_gtr200_res_refit_gz);
    tree->Branch("rk_pair_plus_gtr300_res_refit_gx", &rk_pair_plus_gtr300_res_refit_gx);
    tree->Branch("rk_pair_plus_gtr300_res_refit_gy", &rk_pair_plus_gtr300_res_refit_gy);
    tree->Branch("rk_pair_plus_gtr300_res_refit_gz", &rk_pair_plus_gtr300_res_refit_gz);
  };
...
//    n_pairs = cands.NumSelectedTrackCandidatePairs();
    ...
    rk_pair_minus_ssd_res_refit_gx.resize(n_pairs);
    rk_pair_minus_ssd_res_refit_gy.resize(n_pairs);
    rk_pair_minus_ssd_res_refit_gz.resize(n_pairs);
    rk_pair_minus_gtr100_res_refit_gx.resize(n_pairs);
    rk_pair_minus_gtr100_res_refit_gy.resize(n_pairs);
    rk_pair_minus_gtr100_res_refit_gz.resize(n_pairs);
    rk_pair_minus_gtr200_res_refit_gx.resize(n_pairs);
    rk_pair_minus_gtr200_res_refit_gy.resize(n_pairs);
    rk_pair_minus_gtr200_res_refit_gz.resize(n_pairs);
    rk_pair_minus_gtr300_res_refit_gx.resize(n_pairs);
    rk_pair_minus_gtr300_res_refit_gy.resize(n_pairs);
    rk_pair_minus_gtr300_res_refit_gz.resize(n_pairs);
    rk_pair_plus_ssd_res_refit_gx.resize(n_pairs);
    rk_pair_plus_ssd_res_refit_gy.resize(n_pairs);
    rk_pair_plus_ssd_res_refit_gz.resize(n_pairs);
    rk_pair_plus_gtr100_res_refit_gx.resize(n_pairs);
    rk_pair_plus_gtr100_res_refit_gy.resize(n_pairs);
    rk_pair_plus_gtr100_res_refit_gz.resize(n_pairs);
    rk_pair_plus_gtr200_res_refit_gx.resize(n_pairs);
    rk_pair_plus_gtr200_res_refit_gy.resize(n_pairs);
    rk_pair_plus_gtr200_res_refit_gz.resize(n_pairs);
    rk_pair_plus_gtr300_res_refit_gx.resize(n_pairs);
    rk_pair_plus_gtr300_res_refit_gy.resize(n_pairs);
    rk_pair_plus_gtr300_res_refit_gz.resize(n_pairs);
...
//      auto pair = cands.SelectedTrackCandidatePair(i);
      ...
      rk_pair_minus_ssd_res_refit_gx[i] = mress_refit[0].X();
      rk_pair_minus_ssd_res_refit_gy[i] = mress_refit[0].Y();
      rk_pair_minus_ssd_res_refit_gz[i] = mress_refit[0].Z();
      rk_pair_minus_gtr100_res_refit_gx[i] = mress_refit[1].X();
      rk_pair_minus_gtr100_res_refit_gy[i] = mress_refit[1].Y();
      rk_pair_minus_gtr100_res_refit_gz[i] = mress_refit[1].Z();
      rk_pair_minus_gtr200_res_refit_gx[i] = mress_refit[2].X();
      rk_pair_minus_gtr200_res_refit_gy[i] = mress_refit[2].Y();
      rk_pair_minus_gtr200_res_refit_gz[i] = mress_refit[2].Z();
      rk_pair_minus_gtr300_res_refit_gx[i] = mress_refit[3].X();
      rk_pair_minus_gtr300_res_refit_gy[i] = mress_refit[3].Y();
      rk_pair_minus_gtr300_res_refit_gz[i] = mress_refit[3].Z();
      auto& press_refit = pair.track_plus_res_refit;
      rk_pair_plus_ssd_res_refit_gx[i] = press_refit[0].X();
      rk_pair_plus_ssd_res_refit_gy[i] = press_refit[0].Y();
      rk_pair_plus_ssd_res_refit_gz[i] = press_refit[0].Z();
      rk_pair_plus_gtr100_res_refit_gx[i] = press_refit[1].X();
      rk_pair_plus_gtr100_res_refit_gy[i] = press_refit[1].Y();
      rk_pair_plus_gtr100_res_refit_gz[i] = press_refit[1].Z();
      rk_pair_plus_gtr200_res_refit_gx[i] = press_refit[2].X();
      rk_pair_plus_gtr200_res_refit_gy[i] = press_refit[2].Y();
      rk_pair_plus_gtr200_res_refit_gz[i] = press_refit[2].Z();
      rk_pair_plus_gtr300_res_refit_gx[i] = press_refit[3].X();
      rk_pair_plus_gtr300_res_refit_gy[i] = press_refit[3].Y();
      rk_pair_plus_gtr300_res_refit_gz[i] = press_refit[3].Z();
    }
  }
  TFile file;
  TTree* t_param;
  ...
  std::vector<double> rk_pair_minus_ssd_res_refit_gx;
  std::vector<double> rk_pair_minus_ssd_res_refit_gy;
  std::vector<double> rk_pair_minus_ssd_res_refit_gz;
  std::vector<double> rk_pair_minus_gtr100_res_refit_gx;
  std::vector<double> rk_pair_minus_gtr100_res_refit_gy;
  std::vector<double> rk_pair_minus_gtr100_res_refit_gz;
  std::vector<double> rk_pair_minus_gtr200_res_refit_gx;
  std::vector<double> rk_pair_minus_gtr200_res_refit_gy;
  std::vector<double> rk_pair_minus_gtr200_res_refit_gz;
  std::vector<double> rk_pair_minus_gtr300_res_refit_gx;
  std::vector<double> rk_pair_minus_gtr300_res_refit_gy;
  std::vector<double> rk_pair_minus_gtr300_res_refit_gz;
  std::vector<double> rk_pair_plus_ssd_res_refit_gx;
  std::vector<double> rk_pair_plus_ssd_res_refit_gy;
  std::vector<double> rk_pair_plus_ssd_res_refit_gz;
  std::vector<double> rk_pair_plus_gtr100_res_refit_gx;
  std::vector<double> rk_pair_plus_gtr100_res_refit_gy;
  std::vector<double> rk_pair_plus_gtr100_res_refit_gz;
  std::vector<double> rk_pair_plus_gtr200_res_refit_gx;
  std::vector<double> rk_pair_plus_gtr200_res_refit_gy;
  std::vector<double> rk_pair_plus_gtr200_res_refit_gz;
  std::vector<double> rk_pair_plus_gtr300_res_refit_gx;
  std::vector<double> rk_pair_plus_gtr300_res_refit_gy;
  std::vector<double> rk_pair_plus_gtr300_res_refit_gz;
};
