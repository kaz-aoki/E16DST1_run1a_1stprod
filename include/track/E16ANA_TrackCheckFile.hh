...
//    tree->Branch("trg_track_n_hbd_hits", &trg_track_n_hbd_hits);
    ...
    tree->Branch("n_total_cands", &n_total_cands, "n_total_cands/I");
...
//      trg_track_lg_t[i] = hit.Timing();
 ...
 private:
  ...
  void AddCandidate(E16ANA_GeometryV2& geometry, E16ANA_TrackCandidates& cands) {
    ...
    n_total_cands = cands.NumTrackCandidates();
    n_cands = 0;
    for (int i = 0; i < n_cands; ++i) {
      auto chi2 = cands.TrackCandidates()[i].ChiSquare();
      if (chi2 > kChi2Threshold) {
        continue;
      }
      ++n_cands;
    }
...
//    rk_pair_plus_lg3_t.resize(n_pairs);
    ...
    int n_filled_cands = 0;
    for (int i = 0; i < n_total_cands; ++i) {
      auto& cand = cands.TrackCandidates()[i];
      auto chi2 = cand.ChiSquare();
      if (chi2 > kChi2Threshold) {
        continue;
      }
      track_id[n_filled_cands] = cand.TrackID();
      has_e_hbd_cluster[n_filled_cands] = cand.HasElectronHBDCluster();
      has_e_lg_hit[n_filled_cands] = cand.HasElectronLGHit();
      is_large_residual[n_filled_cands] = cand.IsLargeResidual();
      is_near_target[n_filled_cands] = cand.IsNearTarget();
      is_cluster_used[n_filled_cands] = cand.IsClusterUsed();
      is_selected[n_filled_cands] = cand.IsSelected();
      chi_square[n_filled_cands] = cand.ChiSquare();
      n_steps[n_filled_cands] = cand.NumSteps();
      n_calls[n_filled_cands] = cand.NumCalls();
      x_rough_fit_chi_square[n_filled_cands] = cand.XChiSquare();
      x_rough_fit_coef0[n_filled_cands] = cand.XCoef(0);
      x_rough_fit_coef1[n_filled_cands] = cand.XCoef(1);
      x_rough_fit_coef2[n_filled_cands] = cand.XCoef(2);
      y_rough_fit_chi_square[n_filled_cands] = cand.YChiSquare();
      y_rough_fit_coef0[n_filled_cands] = cand.YCoef(0);
      y_rough_fit_coef1[n_filled_cands] = cand.YCoef(1);
      rk_charge[n_filled_cands] = cand.Charge();
      auto hit_init_mom = cand.InitMom();
      auto hit_init_pos = cand.InitPos();
      rk_hit_init_mom_gx[n_filled_cands] = hit_init_mom.X();
      rk_hit_init_mom_gy[n_filled_cands] = hit_init_mom.Y();
      rk_hit_init_mom_gz[n_filled_cands] = hit_init_mom.Z();
      rk_hit_init_pos_gx[n_filled_cands] = hit_init_pos.X();
      rk_hit_init_pos_gy[n_filled_cands] = hit_init_pos.Y();
      rk_hit_init_pos_gz[n_filled_cands] = hit_init_pos.Z();
      auto& pairs = cand.ClusterPairs();
      auto& ssdhit_gpos = pairs[0].GlobalPos();
      rk_hit_ssd_gx[n_filled_cands] = ssdhit_gpos.X();
      rk_hit_ssd_gy[n_filled_cands] = ssdhit_gpos.Y();
      rk_hit_ssd_gz[n_filled_cands] = ssdhit_gpos.Z();
      auto ssd_clst = dynamic_cast<E16DST_DST1SSDCluster*>(pairs[0].Cluster(0));
      rk_hit_ssd_id[n_filled_cands] = ssd_clst->ClusterId();
      rk_hit_ssd_adc[n_filled_cands] = ssd_clst->PeakSum();
//      rk_hit_ssd_t[n_filled_cands]  = ssd_clst->Timing();
      rk_hit_ssd_t[n_filled_cands]  = ssd_clst->TimingFit();
      rk_hit_ssd_chi2[n_filled_cands] = ssd_clst->Chi2NdfFit();
      auto& gtr100hit_gpos = pairs[1].GlobalPos();
      rk_hit_gtr100_gtx[n_filled_cands]  = gtr100hit_gpos.X();
      rk_hit_gtr100_gty[n_filled_cands]  = gtr100hit_gpos.Y();
      rk_hit_gtr100_gtz[n_filled_cands]  = gtr100hit_gpos.Z();
      auto& gtr100hit_gpos2 = pairs[1].GlobalPosT();
      rk_hit_gtr100_gtx2[n_filled_cands] = gtr100hit_gpos2.X();
      rk_hit_gtr100_gtz2[n_filled_cands] = gtr100hit_gpos2.Z();
      rk_hit_gtr100_nc[n_filled_cands]   = pairs[1].NumCls();
      rk_hit_gtr100_the2[n_filled_cands] = pairs[1].Theta();
      ...
      rk_hit_gtr100_xid[n_filled_cands] = gtr100_xclst->ClusterId();
      rk_hit_gtr100_yid[n_filled_cands] = gtr100_yclst->ClusterId();
      rk_hit_gtr100_xadc[n_filled_cands] = gtr100_xclst->PeakSum();
      rk_hit_gtr100_yadc[n_filled_cands] = gtr100_yclst->PeakSum();
      rk_hit_gtr100_xt[n_filled_cands] = gtr100_xclst->Timing();
      rk_hit_gtr100_yt[n_filled_cands] = gtr100_yclst->Timing();
      rk_hit_gtr100_xt2[n_filled_cands] = gtr100_xclst->Timing2();
      rk_hit_gtr100_yt2[n_filled_cands] = gtr100_yclst->Timing2();
      rk_hit_gtr100_gx[n_filled_cands]  = gtr100_xclst->GlobalPos(geometry).X();
      rk_hit_gtr100_gy[n_filled_cands]  = gtr100_yclst->GlobalPos(geometry).Y();
      rk_hit_gtr100_gz[n_filled_cands]  = gtr100_xclst->GlobalPos(geometry).Z();
      rk_hit_gtr100_the[n_filled_cands] = gtr100_xclst->TanTheta();
      auto& gtr200hit_gpos = pairs[2].GlobalPos();
      rk_hit_gtr200_gtx[n_filled_cands]  = gtr200hit_gpos.X();
      rk_hit_gtr200_gty[n_filled_cands]  = gtr200hit_gpos.Y();
      rk_hit_gtr200_gtz[n_filled_cands]  = gtr200hit_gpos.Z();
      auto& gtr200hit_gpos2 = pairs[2].GlobalPosT();
      rk_hit_gtr200_gtx2[n_filled_cands] = gtr200hit_gpos2.X();
      rk_hit_gtr200_gtz2[n_filled_cands] = gtr200hit_gpos2.Z();
      rk_hit_gtr200_nc[n_filled_cands]   = pairs[2].NumCls();
      rk_hit_gtr200_the2[n_filled_cands] = pairs[2].Theta();
      ...
      rk_hit_gtr200_xid[n_filled_cands] = gtr200_xclst->ClusterId();
      rk_hit_gtr200_yid[n_filled_cands] = gtr200_yclst->ClusterId();
      rk_hit_gtr200_xadc[n_filled_cands] = gtr200_xclst->PeakSum();
      rk_hit_gtr200_yadc[n_filled_cands] = gtr200_yclst->PeakSum();
      rk_hit_gtr200_xt[n_filled_cands] = gtr200_xclst->Timing();
      rk_hit_gtr200_yt[n_filled_cands] = gtr200_yclst->Timing();
      rk_hit_gtr200_xt2[n_filled_cands] = gtr200_xclst->Timing2();
      rk_hit_gtr200_yt2[n_filled_cands] = gtr200_yclst->Timing2();
      rk_hit_gtr200_gx[n_filled_cands]  = gtr200_xclst->GlobalPos(geometry).X();
      rk_hit_gtr200_gy[n_filled_cands]  = gtr200_yclst->GlobalPos(geometry).Y();
      rk_hit_gtr200_gz[n_filled_cands]  = gtr200_xclst->GlobalPos(geometry).Z();
      rk_hit_gtr200_the[n_filled_cands] = gtr200_xclst->TanTheta();
      auto& gtr300hit_gpos = pairs[3].GlobalPos();
      rk_hit_gtr300_gtx[n_filled_cands]  = gtr300hit_gpos.X();
      rk_hit_gtr300_gty[n_filled_cands]  = gtr300hit_gpos.Y();
      rk_hit_gtr300_gtz[n_filled_cands]  = gtr300hit_gpos.Z();
      auto& gtr300hit_gpos2 = pairs[3].GlobalPosT();
      rk_hit_gtr300_gtx2[n_filled_cands] = gtr300hit_gpos2.X();
      rk_hit_gtr300_gtz2[n_filled_cands] = gtr300hit_gpos2.Z();
      rk_hit_gtr300_nc[n_filled_cands]   = pairs[3].NumCls();
      rk_hit_gtr300_the2[n_filled_cands] = pairs[3].Theta();
      ...
      rk_hit_gtr300_xid[n_filled_cands] = gtr300_xclst->ClusterId();
      rk_hit_gtr300_yid[n_filled_cands] = gtr300_yclst->ClusterId();
      rk_hit_gtr300_xadc[n_filled_cands] = gtr300_xclst->PeakSum();
      rk_hit_gtr300_yadc[n_filled_cands] = gtr300_yclst->PeakSum();
      rk_hit_gtr300_xt[n_filled_cands] = gtr300_xclst->Timing();
      rk_hit_gtr300_yt[n_filled_cands] = gtr300_yclst->Timing();
      rk_hit_gtr300_xt2[n_filled_cands] = gtr300_xclst->Timing2();
      rk_hit_gtr300_yt2[n_filled_cands] = gtr300_yclst->Timing2();
      rk_hit_gtr300_gx[n_filled_cands]  = gtr300_xclst->GlobalPos(geometry).X();
      rk_hit_gtr300_gy[n_filled_cands]  = gtr300_yclst->GlobalPos(geometry).Y();
      rk_hit_gtr300_gz[n_filled_cands]  = gtr300_xclst->GlobalPos(geometry).Z();
      rk_hit_gtr300_the[n_filled_cands] = gtr300_xclst->TanTheta();
      auto fit_init_mom = cand.FitInitMom();
      rk_fit_init_mom_gx[n_filled_cands] = fit_init_mom.X();
      rk_fit_init_mom_gy[n_filled_cands] = fit_init_mom.Y();
      rk_fit_init_mom_gz[n_filled_cands] = fit_init_mom.Z();
      auto fit_init_pos = cand.FitInitPos();
      rk_fit_init_pos_gx[n_filled_cands] = fit_init_pos.X();
      rk_fit_init_pos_gy[n_filled_cands] = fit_init_pos.Y();
      rk_fit_init_pos_gz[n_filled_cands] = fit_init_pos.Z();
      rk_res_init_pos_gx[n_filled_cands] = rk_hit_init_pos_gx[n_filled_cands] - rk_fit_init_pos_gx[n_filled_cands];
      rk_res_init_pos_gy[n_filled_cands] = rk_hit_init_pos_gy[n_filled_cands] - rk_fit_init_pos_gy[n_filled_cands];
      rk_res_init_pos_gz[n_filled_cands] = rk_hit_init_pos_gz[n_filled_cands] - rk_fit_init_pos_gz[n_filled_cands];
      rk_res_init_mom_gx[n_filled_cands] = rk_hit_init_mom_gx[n_filled_cands] - rk_fit_init_mom_gx[n_filled_cands];
      rk_res_init_mom_gy[n_filled_cands] = rk_hit_init_mom_gy[n_filled_cands] - rk_fit_init_mom_gy[n_filled_cands];
      rk_res_init_mom_gz[n_filled_cands] = rk_hit_init_mom_gz[n_filled_cands] - rk_fit_init_mom_gz[n_filled_cands];
      const auto& fits = cand.LocalFitResults();
      rk_fit_ssd_mid[n_filled_cands] = fits[0].module_id;
      auto& ssdfit_gpos = fits[0].global_pos;
      rk_fit_ssd_gx[n_filled_cands] = ssdfit_gpos.X();
      rk_fit_ssd_gy[n_filled_cands] = ssdfit_gpos.Y();
      rk_fit_ssd_gz[n_filled_cands] = ssdfit_gpos.Z();
      rk_res_ssd_x[n_filled_cands] = fits[0].residual_pos.X();
      rk_fit_gtr100_mid[n_filled_cands] = fits[1].module_id;
      auto& gtr100fit_gpos = fits[1].global_pos;
      rk_fit_gtr100_gx[n_filled_cands] = gtr100fit_gpos.X();
      rk_fit_gtr100_gy[n_filled_cands] = gtr100fit_gpos.Y();
      rk_fit_gtr100_gz[n_filled_cands] = gtr100fit_gpos.Z();
      rk_res_gtr100_x[n_filled_cands] = fits[1].residual_pos.X();
      rk_res_gtr100_y[n_filled_cands] = fits[1].residual_pos.Y();
      rk_res_gtr100_tx[n_filled_cands]  = fits[1].residual_post.X();
      rk_res_gtr100_ty[n_filled_cands]  = fits[1].residual_post.Y();
      rk_res_gtr100_tx2[n_filled_cands] = fits[1].residual_post2.X();
      rk_fit_gtr200_mid[n_filled_cands] = fits[2].module_id;
      auto& gtr200fit_gpos = fits[2].global_pos;
      rk_fit_gtr200_gx[n_filled_cands] = gtr200fit_gpos.X();
      rk_fit_gtr200_gy[n_filled_cands] = gtr200fit_gpos.Y();
      rk_fit_gtr200_gz[n_filled_cands] = gtr200fit_gpos.Z();
      rk_res_gtr200_x[n_filled_cands] = fits[2].residual_pos.X();
      rk_res_gtr200_y[n_filled_cands] = fits[2].residual_pos.Y();
      rk_res_gtr200_tx[n_filled_cands]  = fits[2].residual_post.X();
      rk_res_gtr200_ty[n_filled_cands]  = fits[2].residual_post.Y();
      rk_res_gtr200_tx2[n_filled_cands] = fits[2].residual_post2.X();
      rk_fit_gtr300_mid[n_filled_cands] = fits[3].module_id;
      auto& gtr300fit_gpos = fits[3].global_pos;
      rk_fit_gtr300_gx[n_filled_cands] = gtr300fit_gpos.X();
      rk_fit_gtr300_gy[n_filled_cands] = gtr300fit_gpos.Y();
      rk_fit_gtr300_gz[n_filled_cands] = gtr300fit_gpos.Z();
      rk_res_gtr300_x[n_filled_cands] = fits[3].residual_pos.X();
      rk_res_gtr300_y[n_filled_cands] = fits[3].residual_pos.Y();
      rk_res_gtr300_tx[n_filled_cands]  = fits[3].residual_post.X();
      rk_res_gtr300_ty[n_filled_cands]  = fits[3].residual_post.Y();
      rk_res_gtr300_tx2[n_filled_cands] = fits[3].residual_post2.X();
      rk_fit_hbd_mid[n_filled_cands] = fits[4].module_id;
      auto& hbdfit_lpos = fits[4].local_pos;
      rk_fit_hbd_x[n_filled_cands] = hbdfit_lpos.X();
      rk_fit_hbd_y[n_filled_cands] = hbdfit_lpos.Y();
      auto& hbdfit_gpos = fits[4].global_pos;
      rk_fit_hbd_gx[n_filled_cands] = hbdfit_gpos.X();
      rk_fit_hbd_gy[n_filled_cands] = hbdfit_gpos.Y();
      rk_fit_hbd_gz[n_filled_cands] = hbdfit_gpos.Z();
      rk_fit_lg_c_mid[n_filled_cands] = fits[5].module_id;
      auto& lgcfit_lpos = fits[5].local_pos;
      rk_fit_lg_c_x[n_filled_cands] = lgcfit_lpos.X();
      rk_fit_lg_c_y[n_filled_cands] = lgcfit_lpos.Y();
      auto& lgcfit_gpos = fits[5].global_pos;
      rk_fit_lg_c_gx[n_filled_cands] = lgcfit_gpos.X();
      rk_fit_lg_c_gy[n_filled_cands] = lgcfit_gpos.Y();
      rk_fit_lg_c_gz[n_filled_cands] = lgcfit_gpos.Z();
      rk_fit_lg_b_mid[n_filled_cands] = fits[6].module_id;
      auto& lgbfit_lpos = fits[6].local_pos;
      rk_fit_lg_b_x[n_filled_cands] = lgbfit_lpos.X();
      rk_fit_lg_b_y[n_filled_cands] = lgbfit_lpos.Y();
      auto& lgbfit_gpos = fits[6].global_pos;
      rk_fit_lg_b_gx[n_filled_cands] = lgbfit_gpos.X();
      rk_fit_lg_b_gy[n_filled_cands] = lgbfit_gpos.Y();
      rk_fit_lg_b_gz[n_filled_cands] = lgbfit_gpos.Z();
      rk_fit_lg_a_mid[n_filled_cands] = fits[7].module_id;
      auto& lgafit_lpos = fits[7].local_pos;
      rk_fit_lg_a_x[n_filled_cands] = lgafit_lpos.X();
      rk_fit_lg_a_y[n_filled_cands] = lgafit_lpos.Y();
      auto& lgafit_gpos = fits[7].global_pos;
      rk_fit_lg_a_gx[n_filled_cands] = lgafit_gpos.X();
      rk_fit_lg_a_gy[n_filled_cands] = lgafit_gpos.Y();
      rk_fit_lg_a_gz[n_filled_cands] = lgafit_gpos.Z();
      auto proj_tgt0 = cand.PosAtTarget(0);
      rk_proj_tgt0_gx[n_filled_cands] = proj_tgt0.X();
      rk_proj_tgt0_gy[n_filled_cands] = proj_tgt0.Y();
      rk_proj_tgt0_gz[n_filled_cands] = proj_tgt0.Z();
      auto proj_tgt1 = cand.PosAtTarget(1);
      rk_proj_tgt1_gx[n_filled_cands] = proj_tgt1.X();
      rk_proj_tgt1_gy[n_filled_cands] = proj_tgt1.Y();
      rk_proj_tgt1_gz[n_filled_cands] = proj_tgt1.Z();
      auto proj_tgt2 = cand.PosAtTarget(2);
      rk_proj_tgt2_gx[n_filled_cands] = proj_tgt2.X();
      rk_proj_tgt2_gy[n_filled_cands] = proj_tgt2.Y();
      rk_proj_tgt2_gz[n_filled_cands] = proj_tgt2.Z();
      auto proj_tgt_mom0 = cand.MomAtTarget(0);
      rk_proj_tgt0_mom_gx[n_filled_cands] = proj_tgt_mom0.X();
      rk_proj_tgt0_mom_gy[n_filled_cands] = proj_tgt_mom0.Y();
      rk_proj_tgt0_mom_gz[n_filled_cands] = proj_tgt_mom0.Z();
      auto proj_tgt_mom1 = cand.MomAtTarget(1);
      rk_proj_tgt1_mom_gx[n_filled_cands] = proj_tgt_mom1.X();
      rk_proj_tgt1_mom_gy[n_filled_cands] = proj_tgt_mom1.Y();
      rk_proj_tgt1_mom_gz[n_filled_cands] = proj_tgt_mom1.Z();
      auto proj_tgt_mom2 = cand.MomAtTarget(2);
      rk_proj_tgt2_mom_gx[n_filled_cands] = proj_tgt_mom2.X();
      rk_proj_tgt2_mom_gy[n_filled_cands] = proj_tgt_mom2.Y();
      rk_proj_tgt2_mom_gz[n_filled_cands] = proj_tgt_mom2.Z();
      auto proj_x0 = cand.PosAtX0();
      rk_proj_x0_gx[n_filled_cands] = proj_x0.X();
      rk_proj_x0_gy[n_filled_cands] = proj_x0.Y();
      rk_proj_x0_gz[n_filled_cands] = proj_x0.Z();
      auto proj_x0_mom = cand.MomAtX0();
      rk_proj_x0_mom_gx[n_filled_cands] = proj_x0_mom.X();
      rk_proj_x0_mom_gy[n_filled_cands] = proj_x0_mom.Y();
      rk_proj_x0_mom_gz[n_filled_cands] = proj_x0_mom.Z();
      auto& proj_hbd_clusters = cand.ProjectedHBDClusters();
      auto n_proj_hbd = proj_hbd_clusters.size();
      rk_proj_n_hbd[n_filled_cands] = n_proj_hbd;
      rk_proj_hbd_id[n_filled_cands].resize(n_proj_hbd);
      rk_proj_hbd_mid[n_filled_cands].resize(n_proj_hbd);
      rk_proj_hbd_x[n_filled_cands].resize(n_proj_hbd);
      rk_proj_hbd_y[n_filled_cands].resize(n_proj_hbd);
      rk_proj_hbd_adc[n_filled_cands].resize(n_proj_hbd);
      rk_proj_hbd_t[n_filled_cands].resize(n_proj_hbd);
      rk_proj_hbd_ftime[n_filled_cands].resize(n_proj_hbd);
      rk_proj_hbd_tdiff[n_filled_cands].resize(n_proj_hbd);
      rk_proj_hbd_size[n_filled_cands] .resize(n_proj_hbd);
      rk_proj_hbd_eprob[n_filled_cands].resize(n_proj_hbd);
      rk_proj_hbd_cprob[n_filled_cands].resize(n_proj_hbd);
      for (int j = 0; j < n_proj_hbd; ++j) {
        auto& hbdclst = proj_hbd_clusters[j];
        auto proj_hbdlpos = hbdclst->LocalPos();
        rk_proj_hbd_id[n_filled_cands][j]    = hbdclst->ClusterId();
        rk_proj_hbd_mid[n_filled_cands][j]   = hbdclst->ModuleId();
        rk_proj_hbd_x[n_filled_cands][j]     = proj_hbdlpos.X();
        rk_proj_hbd_y[n_filled_cands][j]     = proj_hbdlpos.Y();
        rk_proj_hbd_adc[n_filled_cands][j]   = hbdclst->PeakSum();
        rk_proj_hbd_t[n_filled_cands][j]     = hbdclst->Timing();
        rk_proj_hbd_ftime[n_filled_cands][j] = hbdclst->FastestTiming();
        rk_proj_hbd_tdiff[n_filled_cands][j] = hbdclst->TimeDifference();
        rk_proj_hbd_size[n_filled_cands][j]  = hbdclst->ClusterSize();
        rk_proj_hbd_eprob[n_filled_cands][j] = hbdclst->IsE();
        rk_proj_hbd_cprob[n_filled_cands][j] = hbdclst->IsChargedParticle();
      }
      auto& proj_lg_hits = cand.ProjectedLGHits();
      auto n_proj_lg = proj_lg_hits.size();
      rk_proj_n_lg[n_filled_cands] = n_proj_lg;
      rk_proj_lg_id[n_filled_cands].resize(n_proj_lg);
      rk_proj_lg_mid[n_filled_cands].resize(n_proj_lg);
      rk_proj_lg_cid[n_filled_cands].resize(n_proj_lg);
      rk_proj_lg_x[n_filled_cands].resize(n_proj_lg);
      rk_proj_lg_y[n_filled_cands].resize(n_proj_lg);
      rk_proj_lg_adc[n_filled_cands].resize(n_proj_lg);
      rk_proj_lg_t[n_filled_cands].resize(n_proj_lg);
      rk_proj_lg_npeaks[n_filled_cands].resize(n_proj_lg);
      rk_proj_lg_fflag[n_filled_cands].resize(n_proj_lg);
      for (int j = 0; j < n_proj_lg; ++j) {
        auto& lghit = proj_lg_hits[j];
        auto lglpos = lghit->LocalPos(geometry);
        rk_proj_lg_id[n_filled_cands][j]     = lghit->HitId();
        rk_proj_lg_mid[n_filled_cands][j]    = lghit->ModuleId();
        rk_proj_lg_cid[n_filled_cands][j]    = lghit->ChannelId();
        rk_proj_lg_x[n_filled_cands][j]      = lglpos.X();
        rk_proj_lg_y[n_filled_cands][j]      = lglpos.Y();
        rk_proj_lg_adc[n_filled_cands][j]    = lghit->FitPeak();
        rk_proj_lg_t[n_filled_cands][j]      = lghit->Timing();
        rk_proj_lg_npeaks[n_filled_cands][j] = lghit->Npeaks();
        rk_proj_lg_fflag[n_filled_cands][j]  = lghit->FitFlag();
      }
//      rk_proj_hbd0_id[n_filled_cands] = -10000;
//      rk_proj_hbd0_mid[n_filled_cands] = -10000;
//      rk_proj_hbd0_x[n_filled_cands] = -10000.;
//      rk_proj_hbd0_y[n_filled_cands] = -10000.;
//      rk_proj_hbd0_adc[n_filled_cands] = -10000.;
//      rk_proj_hbd0_t[n_filled_cands] = -10000.;
//      rk_proj_hbd0_ftime[n_filled_cands] = -10000.;
//      rk_proj_hbd0_tdiff[n_filled_cands] = -10000.;
//      rk_proj_hbd0_size[n_filled_cands] = -10000.;
//      rk_proj_hbd0_eprob[n_filled_cands] = -10000.;
//      rk_proj_hbd0_cprob[n_filled_cands] = -10000.;
//      rk_proj_hbd1_id[n_filled_cands] = -10000;
//      rk_proj_hbd1_mid[n_filled_cands] = -10000;
//      rk_proj_hbd1_x[n_filled_cands] = -10000.;
//      rk_proj_hbd1_y[n_filled_cands] = -10000.;
//      rk_proj_hbd1_adc[n_filled_cands] = -10000.;
//      rk_proj_hbd1_t[n_filled_cands] = -10000.;
//      rk_proj_hbd1_ftime[n_filled_cands] = -10000.;
//      rk_proj_hbd1_tdiff[n_filled_cands] = -10000.;
//      rk_proj_hbd1_size[n_filled_cands] = -10000.;
//      rk_proj_hbd1_eprob[n_filled_cands] = -10000.;
//      rk_proj_hbd1_cprob[n_filled_cands] = -10000.;
//      rk_proj_hbd2_id[n_filled_cands] = -10000;
//      rk_proj_hbd2_mid[n_filled_cands] = -10000;
//      rk_proj_hbd2_x[n_filled_cands] = -10000.;
//      rk_proj_hbd2_y[n_filled_cands] = -10000.;
//      rk_proj_hbd2_adc[n_filled_cands] = -10000.;
//      rk_proj_hbd2_t[n_filled_cands] = -10000.;
//      rk_proj_hbd2_ftime[n_filled_cands] = -10000.;
//      rk_proj_hbd2_tdiff[n_filled_cands] = -10000.;
//      rk_proj_hbd2_size[n_filled_cands] = -10000.;
//      rk_proj_hbd2_eprob[n_filled_cands] = -10000.;
//      rk_proj_hbd2_cprob[n_filled_cands] = -10000.;
//      rk_proj_hbd3_id[n_filled_cands] = -10000;
//      rk_proj_hbd3_mid[n_filled_cands] = -10000;
//      rk_proj_hbd3_x[n_filled_cands] = -10000.;
//      rk_proj_hbd3_y[n_filled_cands] = -10000.;
//      rk_proj_hbd3_adc[n_filled_cands] = -10000.;
//      rk_proj_hbd3_t[n_filled_cands] = -10000.;
//      rk_proj_hbd3_ftime[n_filled_cands] = -10000.;
//      rk_proj_hbd3_tdiff[n_filled_cands] = -10000.;
//      rk_proj_hbd3_size[n_filled_cands] = -10000.;
//      rk_proj_hbd3_eprob[n_filled_cands] = -10000.;
//      rk_proj_hbd3_cprob[n_filled_cands] = -10000.;
//      auto n_hbd_proj = proj_hbd_clusters.size();
//      if (n_hbd_proj >= 1) {
//        auto& hbdclst = proj_hbd_clusters[0];
//        rk_proj_hbd0_id[n_filled_cands] = hbdclst->ClusterId();
//        rk_proj_hbd0_mid[n_filled_cands] = hbdclst->ModuleId();
//        auto proj_hbdlpos = hbdclst->LocalPos();
//        rk_proj_hbd0_x[n_filled_cands] = proj_hbdlpos.X();
//        rk_proj_hbd0_y[n_filled_cands] = proj_hbdlpos.Y();
//        rk_proj_hbd0_adc[n_filled_cands] = hbdclst->PeakSum();
//        rk_proj_hbd0_t[n_filled_cands] = hbdclst->Timing();
//        rk_proj_hbd0_ftime[n_filled_cands] = hbdclst->FastestTiming();
//        rk_proj_hbd0_tdiff[n_filled_cands] = hbdclst->TimeDifference();
//        rk_proj_hbd0_size[n_filled_cands] = hbdclst->ClusterSize();
//        rk_proj_hbd0_eprob[n_filled_cands] = hbdclst->IsE();
//        rk_proj_hbd0_cprob[n_filled_cands] = hbdclst->IsChargedParticle();
//      }
//      if (n_hbd_proj >= 2) {
//        auto& hbdclst = proj_hbd_clusters[1];
//        rk_proj_hbd1_id[n_filled_cands] = hbdclst->ClusterId();
//        rk_proj_hbd1_mid[n_filled_cands] = hbdclst->ModuleId();
//        auto proj_hbdlpos = hbdclst->LocalPos();
//        rk_proj_hbd1_x[n_filled_cands] = proj_hbdlpos.X();
//        rk_proj_hbd1_y[n_filled_cands] = proj_hbdlpos.Y();
//        rk_proj_hbd1_adc[n_filled_cands] = hbdclst->PeakSum();
//        rk_proj_hbd1_t[n_filled_cands] = hbdclst->Timing();
//        rk_proj_hbd1_ftime[n_filled_cands] = hbdclst->FastestTiming();
//        rk_proj_hbd1_tdiff[n_filled_cands] = hbdclst->TimeDifference();
//        rk_proj_hbd1_size[n_filled_cands] = hbdclst->ClusterSize();
//        rk_proj_hbd1_eprob[n_filled_cands] = hbdclst->IsE();
//        rk_proj_hbd1_cprob[n_filled_cands] = hbdclst->IsChargedParticle();
//      }
//      if (n_hbd_proj >= 3) {
//        auto& hbdclst = proj_hbd_clusters[2];
//        rk_proj_hbd2_id[n_filled_cands] = hbdclst->ClusterId();
//        rk_proj_hbd2_mid[n_filled_cands] = hbdclst->ModuleId();
//        auto proj_hbdlpos = hbdclst->LocalPos();
//        rk_proj_hbd2_x[n_filled_cands] = proj_hbdlpos.X();
//        rk_proj_hbd2_y[n_filled_cands] = proj_hbdlpos.Y();
//        rk_proj_hbd2_adc[n_filled_cands] = hbdclst->PeakSum();
//        rk_proj_hbd2_t[n_filled_cands] = hbdclst->Timing();
//        rk_proj_hbd2_ftime[n_filled_cands] = hbdclst->FastestTiming();
//        rk_proj_hbd2_tdiff[n_filled_cands] = hbdclst->TimeDifference();
//        rk_proj_hbd2_size[n_filled_cands] = hbdclst->ClusterSize();
//        rk_proj_hbd2_eprob[n_filled_cands] = hbdclst->IsE();
//        rk_proj_hbd2_cprob[n_filled_cands] = hbdclst->IsChargedParticle();
//      }
//      if (n_hbd_proj >= 4) {
//        auto& hbdclst = proj_hbd_clusters[3];
//        rk_proj_hbd3_id[n_filled_cands] = hbdclst->ClusterId();
//        rk_proj_hbd3_mid[n_filled_cands] = hbdclst->ModuleId();
//        auto proj_hbdlpos = hbdclst->LocalPos();
//        rk_proj_hbd3_x[n_filled_cands] = proj_hbdlpos.X();
//        rk_proj_hbd3_y[n_filled_cands] = proj_hbdlpos.Y();
//        rk_proj_hbd3_adc[n_filled_cands] = hbdclst->PeakSum();
//        rk_proj_hbd3_t[n_filled_cands] = hbdclst->Timing();
//        rk_proj_hbd3_ftime[n_filled_cands] = hbdclst->FastestTiming();
//        rk_proj_hbd3_tdiff[n_filled_cands] = hbdclst->TimeDifference();
//        rk_proj_hbd3_size[n_filled_cands] = hbdclst->ClusterSize();
//        rk_proj_hbd3_eprob[n_filled_cands] = hbdclst->IsE();
//        rk_proj_hbd3_cprob[n_filled_cands] = hbdclst->IsChargedParticle();
//      }
//      auto& proj_lg_hits = cand.ProjectedLGHits();
//      rk_proj_n_lg[n_filled_cands] = proj_lg_hits.size();
//      rk_proj_lg0_id[n_filled_cands] = -10000;
//      rk_proj_lg0_mid[n_filled_cands] = -10000;
//      rk_proj_lg0_cid[n_filled_cands] = -10000;
//      rk_proj_lg0_x[n_filled_cands] = -10000.;
//      rk_proj_lg0_y[n_filled_cands] = -10000.;
//      rk_proj_lg0_adc[n_filled_cands] = -10000.;
//      rk_proj_lg0_t[n_filled_cands] = -10000.;
//      rk_proj_lg0_npeaks[n_filled_cands] = -10000.;
//      rk_proj_lg0_fflag[n_filled_cands] = -10000.;
//      rk_proj_lg1_id[n_filled_cands] = -10000;
//      rk_proj_lg1_mid[n_filled_cands] = -10000;
//      rk_proj_lg1_cid[n_filled_cands] = -10000;
//      rk_proj_lg1_x[n_filled_cands] = -10000.;
//      rk_proj_lg1_y[n_filled_cands] = -10000.;
//      rk_proj_lg1_adc[n_filled_cands] = -10000.;
//      rk_proj_lg1_t[n_filled_cands] = -10000.;
//      rk_proj_lg1_npeaks[n_filled_cands] = -10000.;
//      rk_proj_lg1_fflag[n_filled_cands] = -10000.;
//      rk_proj_lg2_id[n_filled_cands] = -10000;
//      rk_proj_lg2_mid[n_filled_cands] = -10000;
//      rk_proj_lg2_cid[n_filled_cands] = -10000;
//      rk_proj_lg2_x[n_filled_cands] = -10000.;
//      rk_proj_lg2_y[n_filled_cands] = -10000.;
//      rk_proj_lg2_adc[n_filled_cands] = -10000.;
//      rk_proj_lg2_t[n_filled_cands] = -10000.;
//      rk_proj_lg2_npeaks[n_filled_cands] = -10000.;
//      rk_proj_lg2_fflag[n_filled_cands] = -10000.;
//      rk_proj_lg3_id[n_filled_cands] = -10000;
//      rk_proj_lg3_mid[n_filled_cands] = -10000;
//      rk_proj_lg3_cid[n_filled_cands] = -10000;
//      rk_proj_lg3_x[n_filled_cands] = -10000.;
//      rk_proj_lg3_y[n_filled_cands] = -10000.;
//      rk_proj_lg3_adc[n_filled_cands] = -10000.;
//      rk_proj_lg3_t[n_filled_cands] = -10000.;
//      rk_proj_lg3_npeaks[n_filled_cands] = -10000.;
//      rk_proj_lg3_fflag[n_filled_cands] = -10000.;
//      auto n_lg_proj = proj_lg_hits.size();
//      if (n_lg_proj >= 1) {
//        auto& lghit = proj_lg_hits[0];
//        rk_proj_lg0_id[n_filled_cands] = lghit->HitId();
//        rk_proj_lg0_mid[n_filled_cands] = lghit->ModuleId();
//        rk_proj_lg0_cid[n_filled_cands] = lghit->ChannelId();
//        auto lglpos = lghit->LocalPos(geometry);
//        rk_proj_lg0_x[n_filled_cands] = lglpos.X();
//        rk_proj_lg0_y[n_filled_cands] = lglpos.Y();
//        rk_proj_lg0_adc[n_filled_cands] = lghit->FitPeak();
//        rk_proj_lg0_t[n_filled_cands] = lghit->Timing();
//        rk_proj_lg0_npeaks[n_filled_cands] = lghit->Npeaks();
//        rk_proj_lg0_fflag[n_filled_cands] = lghit->FitFlag();
//      }
//      if (n_lg_proj >= 2) {
//        auto& lghit = proj_lg_hits[1];
//        rk_proj_lg1_id[n_filled_cands] = lghit->HitId();
//        rk_proj_lg1_mid[n_filled_cands] = lghit->ModuleId();
//        rk_proj_lg1_cid[n_filled_cands] = lghit->ChannelId();
//        auto lglpos = lghit->LocalPos(geometry);
//        rk_proj_lg1_x[n_filled_cands] = lglpos.X();
//        rk_proj_lg1_y[n_filled_cands] = lglpos.Y();
//        rk_proj_lg1_adc[n_filled_cands] = lghit->FitPeak();
//        rk_proj_lg1_t[n_filled_cands] = lghit->Timing();
//        rk_proj_lg1_npeaks[n_filled_cands] = lghit->Npeaks();
//        rk_proj_lg1_fflag[n_filled_cands] = lghit->FitFlag();
//      }
//      if (n_lg_proj >= 3) {
//        auto& lghit = proj_lg_hits[2];
//        rk_proj_lg2_id[n_filled_cands] = lghit->HitId();
//        rk_proj_lg2_mid[n_filled_cands] = lghit->ModuleId();
//        rk_proj_lg2_cid[n_filled_cands] = lghit->ChannelId();
//        auto lglpos = lghit->LocalPos(geometry);
//        rk_proj_lg2_x[n_filled_cands] = lglpos.X();
//        rk_proj_lg2_y[n_filled_cands] = lglpos.Y();
//        rk_proj_lg2_adc[n_filled_cands] = lghit->FitPeak();
//        rk_proj_lg2_t[n_filled_cands] = lghit->Timing();
//        rk_proj_lg2_npeaks[n_filled_cands] = lghit->Npeaks();
//        rk_proj_lg2_fflag[n_filled_cands] = lghit->FitFlag();
//      }
//      if (n_lg_proj >= 4) {
//        auto& lghit = proj_lg_hits[3];
//        rk_proj_lg3_id[n_filled_cands] = lghit->HitId();
//        rk_proj_lg3_mid[n_filled_cands] = lghit->ModuleId();
//        rk_proj_lg3_cid[n_filled_cands] = lghit->ChannelId();
//        auto lglpos = lghit->LocalPos(geometry);
//        rk_proj_lg3_x[n_filled_cands] = lglpos.X();
//        rk_proj_lg3_y[n_filled_cands] = lglpos.Y();
//        rk_proj_lg3_adc[n_filled_cands] = lghit->FitPeak();
//        rk_proj_lg3_t[n_filled_cands] = lghit->Timing();
//        rk_proj_lg3_npeaks[n_filled_cands] = lghit->Npeaks();
//        rk_proj_lg3_fflag[n_filled_cands] = lghit->FitFlag();
//      }
      ++n_filled_cands;
    }
