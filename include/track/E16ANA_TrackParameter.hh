...
//const std::array<TVector3, 4> kSigmas = {{{0.1, 0., 0.}, {0.3, 1., 0.}, {0.3, 1., 0.}, {0.3, 1., 0.}}};
//const std::array<TVector3, 4> kSigmas = {{{0.1, 0.,    0.},
//                                          {0.3, 1, 0.},
////                                          {999999, 999999, 0.},
////                                          {3  , 999999, 0.},
//                                          {0.3, 1, 0.},
//                                          {0.3, 1, 0.}}}; // 
const std::array<TVector3, 4> kSigmas = {{{999999999, 9999999999.,    0.},// not used. use varSigmas
                                          {999999999, 999999999, 0.},
//                                          {999999, 999999, 0.},
//                                          {3  , 999999, 0.},
                                          {9999999999, 999999999, 0.},
                                          {99999999, 9999999999, 0.}}}; // 



constexpr std::array<double, 3> kGTRPeakSumThresholdX = {99999, 99999., 99999}; // not used. Use var Thresholds
...
#ifndef TRACK_FIND_WO_TARGET
//constexpr std::array<double, 2> kRoughFitChiSquareThreshold = {200., 20.}; // x, y
//constexpr std::array<double, 2> kRoughFitChiSquareThreshold = {200., 50.}; // x, y // 220413 for statistics check, 220418 for production
constexpr std::array<double, 2> kRoughFitChiSquareThreshold = {500., 20.}; // x, y // Fix 250. if you change it, you need to change varXWeight
...
//constexpr std::array<double, 2> kRoughYFitCoefficientThreshold = {10., 0.}; // coef[1] not used. 231118 stricted
#else // TRACK_FIND_WO_TARGET
...
constexpr std::array<double, 2> kRoughFitChiSquareThreshold = {250., 20.}; // not use
constexpr std::array<double, 3> kRoughXFitCoefficientThreshold = {25, 0, 0.001};//not use 
constexpr std::array<double, 2> kRoughYFitCoefficientThreshold = {15., 0.}; // not used.
#endif // TRACK_FIND_WO_TARGET
