...
constexpr double kGTRYDiffThreshold = 20.; // mm
constexpr std::array<double, 3> kGTRPeakSumThresholdX = {145., 125., 135.}; // 220418 for production
constexpr std::array<double, 3> kGTRMaxTotThresholdX  = {95. , 95. , 90.}; // 220418 for production
constexpr std::array<double, 3> kGTRMaxRtX            = {30. , 30. , 25. }; // 220418 for production
constexpr std::array<double, 3> kGTRstX1              = {110 , 110 , 110.}; // 220418 for production
constexpr std::array<double, 3> kGTRstX2              = {460., 460 , 460.}; // 220418 for production

constexpr std::array<double, 3> kGTRPeakSumThresholdY = {130.,105., 105.}; // 220418 for production
constexpr std::array<double, 3> kGTRMaxTotThresholdY  = {90. , 75. , 75. }; // 220418 for production
constexpr std::array<double, 3> kGTRMaxRtY            = {20. , 20. , 20. }; // 220418 for production
constexpr std::array<double, 3> kGTRstY1              = {110.,110. ,110. }; // 220418 for production
constexpr std::array<double, 3> kGTRstY2              = {460.,460. ,460. }; // 220418 for production

constexpr double kLrpara[3][3] ={{0.173,-0.153,0.452},{0.1672,0.0792,0.475},{0.1684,0.0034,0.4194}};
constexpr double kRrpara[3][3] ={{0.169,-0.276,1.391},{0.1950,0.3264,0.875},{0.2094,0.2920,0.539}};
...
constexpr std::array<double, 2> kRoughFitChiSquareThreshold = {48., 7.};
constexpr double ReRoughFitChi = 48;  
...
constexpr double kMinHBDADCForRK = 5.0;
