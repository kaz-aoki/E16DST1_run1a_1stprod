...
// calculation of hit and cluster size 
    ...
    dst1_clusters.resize(dst1_clusters_size+7);
...
//						  cl.SetMaxTot(anahit.MaxTot());//241022
    ...
    return sizeof(E16DST_DST1GTRHit) * dst1_hits_size + sizeof(E16DST_DST1GTRCluster) * (dst1_clusters_size+7);
