...
int E16DST_DST1GTRFactory_Ex100(E16DST_DST0Detector<E16DST_DST0GTRHit>& dst0_hits, E16DST_DST1Detector<E16DST_DST1GTRHit, E16DST_DST1GTRCluster>* gtr1, E16ANA_GTRcalibPedestal &gtrped,
...
//					std::cout << "cl cog = " << anahit.CogHit() << std::endl;
	...
	cl.SetLayerId(0);
	cl.SetHitOrders(thit_orders);
	cl.SetType(1);//is it ok giving 1?
	cl.SetMaxPeakCh(1);
	cl.SetMaxPeakHeight(99999);
	cl.SetTiming(820);
	cl.SetPeakSum(99999);//cluster charge
