...
void SingleTrackAnalyzerForRes::MkTreeForResidualHBD(int runoption, int maxevent, char* out_file_name)
{
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {//event loop
    ...
    std::cout << "lg  t " << out_track_lg_t[0] << std::endl;
...
void SingleTrackAnalyzerForRes::MkTreeForTrackSelection(int runoption, int maxevent, char* out_file_name, int hbd_track_module, int track_charge, double max_chi_square, E16ANA_GeometryV2 *geometry, E16ANA_MagneticFieldMap3D *bfield_map)
{
   if (fChain == 0) return;
   ...
   vector<double> out_rk_hit_ssd_gx;
   vector<double> out_rk_hit_ssd_gy;
   vector<double> out_rk_hit_ssd_gz;
   vector<double> out_rk_hit_gtr100_gx;
   vector<double> out_rk_hit_gtr100_gtx;
   vector<double> out_rk_hit_gtr100_gty;
   vector<double> out_rk_hit_gtr100_gtx2;
   vector<double> out_rk_hit_gtr100_gtz;
   vector<double> out_rk_hit_gtr100_gtz2;
   vector<double> out_rk_hit_gtr200_gtx;
   vector<double> out_rk_hit_gtr200_gty;
   vector<double> out_rk_hit_gtr200_gtx2;
   vector<double> out_rk_hit_gtr200_gtz;
   vector<double> out_rk_hit_gtr200_gtz2;
   vector<double> out_rk_hit_gtr300_gtz;
   vector<double> out_rk_hit_gtr300_gty;
   vector<double> out_rk_hit_gtr300_gtz2;
   vector<double> out_rk_hit_gtr300_gtx;
   vector<double> out_rk_hit_gtr300_gtx2;
   vector<double> out_rk_hit_gtr100_gy;
   vector<double> out_rk_hit_gtr100_gz;
   vector<double> out_rk_hit_gtr200_gx;
   vector<double> out_rk_hit_gtr200_gy;
   vector<double> out_rk_hit_gtr200_gz;
   vector<double> out_rk_hit_gtr300_gx;
   vector<double> out_rk_hit_gtr300_gy;
   vector<double> out_rk_hit_gtr300_gz;
   vector<double> out_rk_res_ssd_x;
   vector<double> out_rk_res_gtr100_x;
   vector<double> out_rk_res_gtr100_y;
   vector<double> out_rk_res_gtr200_x;
   vector<double> out_rk_res_gtr200_y;
   vector<double> out_rk_res_gtr300_x;
   vector<double> out_rk_res_gtr300_y;
   vector<int> out_track_ssd_cluster_id;
   vector<int> out_track_ssd_cluster_mid;
   vector<int> out_track_gtr100x_cluster_id;
   vector<int> out_track_gtr100_cluster_mid;
   vector<int> out_track_gtr200x_cluster_id;
   vector<int> out_track_gtr200_cluster_mid;
   vector<int> out_track_gtr300x_cluster_id;
   vector<int> out_track_gtr300_cluster_mid;
   vector<int> out_track_gtr100y_cluster_id;
   vector<int> out_track_gtr100yb_cluster_id;
   vector<int> out_track_gtr200y_cluster_id;
   vector<int> out_track_gtr300y_cluster_id;
...
// murakami adds 
   tree->Branch("rk_hit_ssd_gx", &out_rk_hit_ssd_gx);
   tree->Branch("rk_hit_ssd_gy", &out_rk_hit_ssd_gy);
   tree->Branch("rk_hit_ssd_gz", &out_rk_hit_ssd_gz);
   tree->Branch("rk_hit_gtr100_gx", &out_rk_hit_gtr100_gx);
   tree->Branch("rk_hit_gtr100_gtx", &out_rk_hit_gtr100_gtx);
   tree->Branch("rk_hit_gtr100_gty", &out_rk_hit_gtr100_gty);
   tree->Branch("rk_hit_gtr100_gtx2", &out_rk_hit_gtr100_gtx2);
   tree->Branch("rk_hit_gtr100_gy", &out_rk_hit_gtr100_gy);
   tree->Branch("rk_hit_gtr100_gz", &out_rk_hit_gtr100_gz);
   tree->Branch("rk_hit_gtr100_gtz", &out_rk_hit_gtr100_gtz);
   tree->Branch("rk_hit_gtr100_gtz2", &out_rk_hit_gtr100_gtz2);
   tree->Branch("rk_hit_gtr200_gx", &out_rk_hit_gtr200_gx);
   tree->Branch("rk_hit_gtr200_gtx", &out_rk_hit_gtr200_gtx);
   tree->Branch("rk_hit_gtr200_gtx2", &out_rk_hit_gtr200_gtx2);
   tree->Branch("rk_hit_gtr200_gtz2", &out_rk_hit_gtr200_gtz2);
   tree->Branch("rk_hit_gtr200_gy", &out_rk_hit_gtr200_gy);
   tree->Branch("rk_hit_gtr200_gty", &out_rk_hit_gtr200_gty);
   tree->Branch("rk_hit_gtr200_gz", &out_rk_hit_gtr200_gz);
   tree->Branch("rk_hit_gtr300_gx", &out_rk_hit_gtr300_gx);
   tree->Branch("rk_hit_gtr300_gtx", &out_rk_hit_gtr300_gtx);
   tree->Branch("rk_hit_gtr300_gtx2", &out_rk_hit_gtr300_gtx2);
   tree->Branch("rk_hit_gtr300_gy", &out_rk_hit_gtr300_gy);
   tree->Branch("rk_hit_gtr300_gty", &out_rk_hit_gtr300_gty);
   tree->Branch("rk_hit_gtr300_gz", &out_rk_hit_gtr300_gz);
   tree->Branch("rk_hit_gtr300_gtz", &out_rk_hit_gtr300_gtz);
   tree->Branch("rk_hit_gtr300_gtz2", &out_rk_hit_gtr300_gtz2);
   tree->Branch("rk_res_ssd_x" , &out_rk_res_ssd_x );
   tree->Branch("rk_res_gtr100_x" , &out_rk_res_gtr100_x );
   tree->Branch("rk_res_gtr100_y" , &out_rk_res_gtr100_y );
   tree->Branch("rk_res_gtr200_x" , &out_rk_res_gtr200_x );
   tree->Branch("rk_res_gtr200_y" , &out_rk_res_gtr200_y );
   tree->Branch("rk_res_gtr300_x" , &out_rk_res_gtr300_x );
   tree->Branch("rk_res_gtr300_y" , &out_rk_res_gtr300_y );
   tree->Branch("track_ssd_cluster_id", &out_track_ssd_cluster_id);
   tree->Branch("track_ssd_cluster_mid", &out_track_ssd_cluster_mid);
   tree->Branch("track_gtr100x_cluster_id", &out_track_gtr100x_cluster_id);
   tree->Branch("track_gtr200x_cluster_id", &out_track_gtr200x_cluster_id);
   tree->Branch("track_gtr300x_cluster_id", &out_track_gtr300x_cluster_id);
   tree->Branch("track_gtr100y_cluster_id", &out_track_gtr100y_cluster_id);
   tree->Branch("track_gtr200y_cluster_id", &out_track_gtr200y_cluster_id);
   tree->Branch("track_gtr300y_cluster_id", &out_track_gtr300y_cluster_id);
   tree->Branch("track_gtr100yb_cluster_id", &out_track_gtr100y_cluster_id);
   tree->Branch("track_gtr100_cluster_mid", &out_track_gtr100_cluster_mid);
   tree->Branch("track_gtr200_cluster_mid", &out_track_gtr200_cluster_mid);
   tree->Branch("track_gtr300_cluster_mid", &out_track_gtr300_cluster_mid);
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {//event loop
      ...
      out_rk_hit_gtr100_gx.clear();
      out_rk_hit_gtr100_gtx.clear();
      out_rk_hit_gtr100_gty.clear();
      out_rk_hit_gtr100_gtx2.clear();
      out_rk_hit_gtr200_gtx.clear();
      out_rk_hit_gtr200_gty.clear();
      out_rk_hit_gtr200_gtx2.clear();
      out_rk_hit_gtr300_gtx.clear();
      out_rk_hit_gtr300_gty.clear();
      out_rk_hit_gtr300_gtx2.clear();
      out_rk_hit_gtr100_gtz.clear();
      out_rk_hit_gtr100_gtz2.clear();
      out_rk_hit_gtr200_gtz.clear();
      out_rk_hit_gtr200_gtz2.clear();
      out_rk_hit_gtr300_gtz.clear();
      out_rk_hit_gtr300_gtz2.clear();
      out_rk_hit_gtr100_gy.clear();
      out_rk_hit_gtr100_gz.clear();
      out_rk_hit_gtr200_gx.clear();
      out_rk_hit_gtr200_gy.clear();
      out_rk_hit_gtr200_gz.clear();
      out_rk_hit_gtr300_gx.clear();
      out_rk_hit_gtr300_gy.clear();
      out_rk_hit_gtr300_gz.clear();
      out_rk_res_ssd_x.clear();
      out_rk_res_gtr100_x.clear();
      out_rk_res_gtr100_y.clear();
      out_rk_res_gtr200_x.clear();
      out_rk_res_gtr200_y.clear();
      out_rk_res_gtr300_x.clear();
      out_rk_res_gtr300_y.clear();

      out_track_ssd_cluster_id.clear();
      out_track_ssd_cluster_mid.clear();
      out_track_gtr100x_cluster_id.clear();
      out_track_gtr200x_cluster_id.clear();
      out_track_gtr300x_cluster_id.clear();
      out_track_gtr100y_cluster_id.clear();
      out_track_gtr100yb_cluster_id.clear();
      out_track_gtr200y_cluster_id.clear();
      out_track_gtr300y_cluster_id.clear();
      out_track_ssd_cluster_mid.clear();
      out_track_gtr100_cluster_mid.clear();
      out_track_gtr200_cluster_mid.clear();
      out_track_gtr300_cluster_mid.clear();
	...
	//out_track_lg_t.push_back(trk_lg_t);
	out_track_lg_lx.push_back(trk_lg_lx);
	out_track_lg_ly.push_back(trk_lg_ly);
   
   
      out_rk_hit_ssd_gx.push_back(rk_hit_ssd_gx->at(itrack));
      out_rk_hit_ssd_gy.push_back(rk_hit_ssd_gy->at(itrack));
      out_rk_hit_ssd_gz.push_back(rk_hit_ssd_gz->at(itrack));
      out_rk_hit_gtr100_gx.push_back(rk_hit_gtr100_gx->at(itrack));
      out_rk_hit_gtr100_gtx.push_back(rk_hit_gtr100_gtx->at(itrack));
      out_rk_hit_gtr100_gty.push_back(rk_hit_gtr100_gty->at(itrack));
      out_rk_hit_gtr100_gtx2.push_back(rk_hit_gtr100_gtx2->at(itrack));
      out_rk_hit_gtr100_gtz.push_back(rk_hit_gtr100_gtz->at(itrack));
      out_rk_hit_gtr100_gtz2.push_back(rk_hit_gtr100_gtz2->at(itrack));
      out_rk_hit_gtr200_gtz.push_back(rk_hit_gtr200_gtz->at(itrack));
      out_rk_hit_gtr200_gtz2.push_back(rk_hit_gtr200_gtz2->at(itrack));
      out_rk_hit_gtr300_gtz.push_back(rk_hit_gtr300_gtz->at(itrack));
      out_rk_hit_gtr300_gtz2.push_back(rk_hit_gtr300_gtz2->at(itrack));
      out_rk_hit_gtr200_gtx.push_back(rk_hit_gtr200_gtx->at(itrack));
      out_rk_hit_gtr200_gty.push_back(rk_hit_gtr200_gty->at(itrack));
      out_rk_hit_gtr200_gtx2.push_back(rk_hit_gtr200_gtx2->at(itrack));
      out_rk_hit_gtr300_gtx.push_back(rk_hit_gtr300_gtx->at(itrack));
      out_rk_hit_gtr300_gty.push_back(rk_hit_gtr300_gty->at(itrack));
      out_rk_hit_gtr300_gtx2.push_back(rk_hit_gtr300_gtx2->at(itrack));
      out_rk_hit_gtr100_gy.push_back(rk_hit_gtr100_gy->at(itrack));
      out_rk_hit_gtr100_gz.push_back(rk_hit_gtr100_gz->at(itrack));
      out_rk_hit_gtr200_gx.push_back(rk_hit_gtr200_gx->at(itrack));
      out_rk_hit_gtr200_gy.push_back(rk_hit_gtr200_gy->at(itrack));
      out_rk_hit_gtr200_gz.push_back(rk_hit_gtr200_gz->at(itrack));
      out_rk_hit_gtr300_gx.push_back(rk_hit_gtr300_gx->at(itrack));
      out_rk_hit_gtr300_gy.push_back(rk_hit_gtr300_gy->at(itrack));
      out_rk_hit_gtr300_gz.push_back(rk_hit_gtr300_gz->at(itrack));
      out_rk_res_ssd_x.push_back(rk_res_ssd_x->at(itrack));
      out_rk_res_gtr100_x.push_back(rk_res_gtr100_x->at(itrack));
      out_rk_res_gtr100_y.push_back(rk_res_gtr100_y->at(itrack));
      out_rk_res_gtr200_x.push_back(rk_res_gtr200_x->at(itrack));
      out_rk_res_gtr200_y.push_back(rk_res_gtr200_y->at(itrack));
      out_rk_res_gtr300_x.push_back(rk_res_gtr300_x->at(itrack));
      out_rk_res_gtr300_y.push_back(rk_res_gtr300_y->at(itrack));
      out_track_ssd_cluster_id.push_back(rk_hit_ssd_id->at(itrack));
      out_track_gtr100x_cluster_id.push_back(rk_hit_gtr100_xid->at(itrack));
      out_track_gtr200x_cluster_id.push_back(rk_hit_gtr200_xid->at(itrack));
      out_track_gtr300x_cluster_id.push_back(rk_hit_gtr300_xid->at(itrack));
      out_track_gtr100y_cluster_id.push_back(rk_hit_gtr100_yid->at(itrack));
      out_track_gtr200y_cluster_id.push_back(rk_hit_gtr200_yid->at(itrack));
      out_track_gtr300y_cluster_id.push_back(rk_hit_gtr300_yid->at(itrack));
      out_track_ssd_cluster_mid.push_back(rk_fit_ssd_mid->at(itrack));
      out_track_gtr100_cluster_mid.push_back(rk_fit_gtr100_mid->at(itrack));
      out_track_gtr200_cluster_mid.push_back(rk_fit_gtr200_mid->at(itrack));
      out_track_gtr300_cluster_mid.push_back(rk_fit_gtr300_mid->at(itrack));
