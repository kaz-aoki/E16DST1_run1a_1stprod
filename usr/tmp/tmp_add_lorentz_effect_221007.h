...
// Fri Oct  7 15:15:46 2022 by ROOT version 6.18/04
// from TTree tree/tree
// found on file: /work22/ichikawa/lsf_file/22082400-v4/root/track_analyzer_run030717_0_000_ev600-899.root
//////////////////////////////////////////////////////////

#ifndef tmp_add_lorentz_effect_221007_h
#define tmp_add_lorentz_effect_221007_h
...
class tmp_add_lorentz_effect_221007 {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           n_pairs;
   std::vector<double>  *plus_rough_fit_init_z;
   std::vector<double>  *minus_rough_fit_init_z;
   ...
   TBranch        *b_n_pairs;   //!
   TBranch        *b_plus_rough_fit_init_z;   //!
   TBranch        *b_minus_rough_fit_init_z;   //!
   ...
   tmp_add_lorentz_effect_221007(TTree *tree=0);
   virtual ~tmp_add_lorentz_effect_221007();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(const TString& otu_name);
...
#ifdef tmp_add_lorentz_effect_221007_cxx
tmp_add_lorentz_effect_221007::tmp_add_lorentz_effect_221007(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/work22/ichikawa/lsf_file/22082400-v4/root/track_analyzer_run030717_0_000_ev600-899.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/work22/ichikawa/lsf_file/22082400-v4/root/track_analyzer_run030717_0_000_ev600-899.root");
      }
...
tmp_add_lorentz_effect_221007::~tmp_add_lorentz_effect_221007()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t tmp_add_lorentz_effect_221007::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t tmp_add_lorentz_effect_221007::LoadTree(Long64_t entry)
{
...
void tmp_add_lorentz_effect_221007::Init(TTree *tree)
{
   ...
   trg_lg_hit_gz = 0;
   trg_lg_hit_t = 0;
   plus_rough_fit_init_z = 0;
   minus_rough_fit_init_z = 0;
   plus_track_id = 0;
   plus_charge_id = 0;
   hit_plus_ssd_id = 0;
   hit_plus_ssd_lx = 0;
   ...
   fChain->SetBranchAddress("plus_rough_fit_init_z", &plus_rough_fit_init_z, &b_plus_rough_fit_init_z);
   fChain->SetBranchAddress("minus_rough_fit_init_z", &minus_rough_fit_init_z, &b_minus_rough_fit_init_z);
...
Bool_t tmp_add_lorentz_effect_221007::Notify()
{
...
void tmp_add_lorentz_effect_221007::Show(Long64_t entry)
{
...
Int_t tmp_add_lorentz_effect_221007::Cut(Long64_t entry)
{
...
#endif // #ifdef tmp_add_lorentz_effect_221007_cxx
