...
// Mon Jun 27 13:34:58 2022 by ROOT version 6.18/04
// from TTree tree/tree
// found on file: /ccj/w/data06a/E16/user/ichikawa/embedding/mock_dst1/run30717_0_000_allev_w_tdr-smear_wo_embed3.root
//////////////////////////////////////////////////////////

#ifndef tmp_check_pos_smear_220627_h
#define tmp_check_pos_smear_220627_h
...
class tmp_check_pos_smear_220627 {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   tmp_check_pos_smear_220627(TTree *tree=0);
   virtual ~tmp_check_pos_smear_220627();
...
#ifdef tmp_check_pos_smear_220627_cxx
tmp_check_pos_smear_220627::tmp_check_pos_smear_220627(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/ccj/w/data06a/E16/user/ichikawa/embedding/mock_dst1/run30717_0_000_allev_w_tdr-smear_wo_embed3.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/ccj/w/data06a/E16/user/ichikawa/embedding/mock_dst1/run30717_0_000_allev_w_tdr-smear_wo_embed3.root");
      }
...
tmp_check_pos_smear_220627::~tmp_check_pos_smear_220627()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t tmp_check_pos_smear_220627::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t tmp_check_pos_smear_220627::LoadTree(Long64_t entry)
{
...
void tmp_check_pos_smear_220627::Init(TTree *tree)
{
...
Bool_t tmp_check_pos_smear_220627::Notify()
{
...
void tmp_check_pos_smear_220627::Show(Long64_t entry)
{
...
Int_t tmp_check_pos_smear_220627::Cut(Long64_t entry)
{
...
#endif // #ifdef tmp_check_pos_smear_220627_cxx
