...
//  double   wo_fit_mass;
  ...
  out_tree.Branch("plus_hbd_mid",              &plus_hbd_mid,    "plus_hbd_mid/I");
  ...
  out_tree.Branch("minus_hbd_mid",             &minus_hbd_mid,    "minus_hbd_mid/I");
  ...
  out_tree.Branch("mock_plus_hbd_lpos",     &mock_plus_hbd_lpos);
...
out_tree.Branch("mock_plus_z0_mom",           &mock_plus_z0_mom);
  ...
  out_tree.Branch("mock_minus_hbd_lpos",    &mock_minus_hbd_lpos);
...
//    if (Cut(ientry) < 0) continue;
    ...
    plus_hbd_mid           = mock_hbd_mid->at(mock_id);
    minus_hbd_mid          = mock_hbd_mid->at(mock_id + 1);
    mock_plus_hbd_lpos     = TVector3(mock_hbd_lpos_x->at(mock_id),     mock_hbd_lpos_y->at(mock_id),     mock_hbd_lpos_z->at(mock_id));
    mock_minus_hbd_lpos    = TVector3(mock_hbd_lpos_x->at(mock_id + 1), mock_hbd_lpos_y->at(mock_id + 1), mock_hbd_lpos_z->at(mock_id + 1));
