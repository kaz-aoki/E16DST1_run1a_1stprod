...
//  tree->Branch("hit_plus_ssd_adc",                 &em_hit_plus_ssd_adc);
//  tree->Branch("hit_plus_ssd_size",                &em_hit_plus_ssd_size);
  tree->Branch("hit_plus_gtr100_xid",              &em_hit_plus_gtr100_xid);
  tree->Branch("hit_plus_gtr100_yid",              &em_hit_plus_gtr100_yid);
  tree->Branch("hit_plus_gtr100_lx",               &em_hit_plus_gtr100_lx);
  tree->Branch("hit_plus_gtr100_ly",               &em_hit_plus_gtr100_ly);
//  tree->Branch("hit_plus_gtr100_xt",               &em_hit_plus_gtr100_xt);
//  tree->Branch("hit_plus_gtr100_yt",               &em_hit_plus_gtr100_yt);
//  tree->Branch("hit_plus_gtr100_xadc",             &em_hit_plus_gtr100_xadc);
//  tree->Branch("hit_plus_gtr100_yadc",             &em_hit_plus_gtr100_yadc);
//  tree->Branch("hit_plus_gtr100_xsize",            &em_hit_plus_gtr100_xsize);
//  tree->Branch("hit_plus_gtr100_ysize",            &em_hit_plus_gtr100_ysize);
  tree->Branch("hit_plus_gtr200_xid",              &em_hit_plus_gtr200_xid);
  tree->Branch("hit_plus_gtr200_yid",              &em_hit_plus_gtr200_yid);
  tree->Branch("hit_plus_gtr200_lx",               &em_hit_plus_gtr200_lx);
  tree->Branch("hit_plus_gtr200_ly",               &em_hit_plus_gtr200_ly);
//  tree->Branch("hit_plus_gtr200_xt",               &em_hit_plus_gtr200_xt);
//  tree->Branch("hit_plus_gtr200_yt",               &em_hit_plus_gtr200_yt);
//  tree->Branch("hit_plus_gtr200_xadc",             &em_hit_plus_gtr200_xadc);
//  tree->Branch("hit_plus_gtr200_yadc",             &em_hit_plus_gtr200_yadc);
//  tree->Branch("hit_plus_gtr200_xsize",            &em_hit_plus_gtr200_xsize);
//  tree->Branch("hit_plus_gtr200_ysize",            &em_hit_plus_gtr200_ysize);
  tree->Branch("hit_plus_gtr300_xid",              &em_hit_plus_gtr300_xid);
  tree->Branch("hit_plus_gtr300_yid",              &em_hit_plus_gtr300_yid);
  tree->Branch("hit_plus_gtr300_lx",               &em_hit_plus_gtr300_lx);
  tree->Branch("hit_plus_gtr300_ly",               &em_hit_plus_gtr300_ly);
//  tree->Branch("hit_plus_gtr300_xt",               &em_hit_plus_gtr300_xt);
//  tree->Branch("hit_plus_gtr300_yt",               &em_hit_plus_gtr300_yt);
//  tree->Branch("hit_plus_gtr300_xadc",             &em_hit_plus_gtr300_xadc);
//  tree->Branch("hit_plus_gtr300_yadc",             &em_hit_plus_gtr300_yadc);
//  tree->Branch("hit_plus_gtr300_xsize",            &em_hit_plus_gtr300_xsize);
//  tree->Branch("hit_plus_gtr300_ysize",            &em_hit_plus_gtr300_ysize);
...
//  tree->Branch("hit_minus_ssd_adc",                &em_hit_minus_ssd_adc);
//  tree->Branch("hit_minus_ssd_size",               &em_hit_minus_ssd_size);
  tree->Branch("hit_minus_gtr100_xid",             &em_hit_minus_gtr100_xid);
  tree->Branch("hit_minus_gtr100_yid",             &em_hit_minus_gtr100_yid);
  tree->Branch("hit_minus_gtr100_lx",              &em_hit_minus_gtr100_lx);
  tree->Branch("hit_minus_gtr100_ly",              &em_hit_minus_gtr100_ly);
//  tree->Branch("hit_minus_gtr100_xt",              &em_hit_minus_gtr100_xt);
//  tree->Branch("hit_minus_gtr100_yt",              &em_hit_minus_gtr100_yt);
//  tree->Branch("hit_minus_gtr100_xadc",            &em_hit_minus_gtr100_xadc);
//  tree->Branch("hit_minus_gtr100_yadc",            &em_hit_minus_gtr100_yadc);
//  tree->Branch("hit_minus_gtr100_xsize",           &em_hit_minus_gtr100_xsize);
//  tree->Branch("hit_minus_gtr100_ysize",           &em_hit_minus_gtr100_ysize);
  tree->Branch("hit_minus_gtr200_xid",             &em_hit_minus_gtr200_xid);
  tree->Branch("hit_minus_gtr200_yid",             &em_hit_minus_gtr200_yid);
  tree->Branch("hit_minus_gtr200_lx",              &em_hit_minus_gtr200_lx);
  tree->Branch("hit_minus_gtr200_ly",              &em_hit_minus_gtr200_ly);
//  tree->Branch("hit_minus_gtr200_xt",              &em_hit_minus_gtr200_xt);
//  tree->Branch("hit_minus_gtr200_yt",              &em_hit_minus_gtr200_yt);
//  tree->Branch("hit_minus_gtr200_xadc",            &em_hit_minus_gtr200_xadc);
//  tree->Branch("hit_minus_gtr200_yadc",            &em_hit_minus_gtr200_yadc);
//  tree->Branch("hit_minus_gtr200_xsize",           &em_hit_minus_gtr200_xsize);
//  tree->Branch("hit_minus_gtr200_ysize",           &em_hit_minus_gtr200_ysize);
  tree->Branch("hit_minus_gtr300_xid",             &em_hit_minus_gtr300_xid);
  tree->Branch("hit_minus_gtr300_yid",             &em_hit_minus_gtr300_yid);
  tree->Branch("hit_minus_gtr300_lx",              &em_hit_minus_gtr300_lx);
  tree->Branch("hit_minus_gtr300_ly",              &em_hit_minus_gtr300_ly);
//  tree->Branch("hit_minus_gtr300_xt",              &em_hit_minus_gtr300_xt);
//  tree->Branch("hit_minus_gtr300_yt",              &em_hit_minus_gtr300_yt);
//  tree->Branch("hit_minus_gtr300_xadc",            &em_hit_minus_gtr300_xadc);
...
//  tree->Branch("n_pairs2",                         &em_n_pairs);
  ...
  tree->Branch("res_plus_ssd_lx",                  &em_res_plus_ssd_lx);
//  tree->Branch("res_plus_ssd_ly",                  &em_res_plus_ssd_ly);
  tree->Branch("res_plus_gtr100_lx",               &em_res_plus_gtr100_lx);
  tree->Branch("res_plus_gtr100_ly",               &em_res_plus_gtr100_ly);
  tree->Branch("res_plus_gtr200_lx",               &em_res_plus_gtr200_lx);
  tree->Branch("res_plus_gtr200_ly",               &em_res_plus_gtr200_ly);
  tree->Branch("res_plus_gtr300_lx",               &em_res_plus_gtr300_lx);
  tree->Branch("res_plus_gtr300_ly",               &em_res_plus_gtr300_ly);
  tree->Branch("res_minus_ssd_lx",                 &em_res_minus_ssd_lx);
//  tree->Branch("res_minus_ssd_ly",                 &em_res_minus_ssd_ly);
  tree->Branch("res_minus_gtr100_lx",              &em_res_minus_gtr100_lx);
  tree->Branch("res_minus_gtr100_ly",              &em_res_minus_gtr100_ly);
  tree->Branch("res_minus_gtr200_lx",              &em_res_minus_gtr200_lx);
  tree->Branch("res_minus_gtr200_ly",              &em_res_minus_gtr200_ly);
  tree->Branch("res_minus_gtr300_lx",              &em_res_minus_gtr300_lx);
  tree->Branch("res_minus_gtr300_ly",              &em_res_minus_gtr300_ly);
...
bool track_analyzer_220715::HasAssociatedLG(int n) {
	std::array<int, kNumLGTypes> mids = { rk_fit_lg_c_mid->at(n), rk_fit_lg_b_mid->at(n), rk_fit_lg_a_mid->at(n)};  
	for(int t=0; t < kNumLGTypes; t++){
	  if (mids[t] < 101 || mids[t] > 109) {
   	 return false;
	  }
	}
  std::array<TVector3, kNumLGTypes> track_lposs = {TVector3(rk_fit_lg_c_x->at(n), rk_fit_lg_c_y->at(n), 0.),
																	TVector3(rk_fit_lg_b_x->at(n), rk_fit_lg_b_y->at(n), 0.),
																	TVector3(rk_fit_lg_a_x->at(n), rk_fit_lg_a_y->at(n), 0.)};
  int dummy_type;
  double dummy_res;
  return HasAssociatedLG(mids, track_lposs, &dummy_type, &dummy_res,  &associated_hbd_indexs[n]);
}



bool track_analyzer_220715::HasAssociatedLG(array<int, kNumLGTypes> mids, const array<TVector3, kNumLGTypes>& track_poss,
                                            int* min_type, double* min_res, vector<int>* _associated_lg_indexs) {
  *min_res = 10000.;
  bool has_lg = false;
...
bool track_analyzer_220715::IsGoodTrack(int n) {
  ...
  if (kUseLGAssociationCut && !HasAssociatedLG(n)){
	 return false;	
  }
...
//  out_res_minus_ssd_ly.resize(out_n_pairs);
  ...
  out_proj_plus_n_lgs.resize(out_n_pairs);
  out_proj_plus_lg_min_res.resize(out_n_pairs);
  out_proj_plus_lg_id.resize(out_n_pairs);
  out_proj_plus_lg_lx.resize(out_n_pairs);
  out_proj_plus_lg_ly.resize(out_n_pairs);
  out_proj_plus_lg_resx.resize(out_n_pairs);
  ...
  out_proj_minus_lg_lx.resize(out_n_pairs);
  out_proj_minus_lg_ly.resize(out_n_pairs);
  out_proj_minus_lg_resx.resize(out_n_pairs);
  out_proj_minus_lg_resy.resize(out_n_pairs);
  out_proj_minus_lg_adc.resize(out_n_pairs);
  out_proj_minus_lg_size.resize(out_n_pairs);
...
//  em_hit_plus_ssd_adc.clear();
//  em_hit_plus_ssd_size.clear();
  em_hit_plus_gtr100_xid.clear();
  em_hit_plus_gtr100_yid.clear();
  em_hit_plus_gtr100_lx.clear();
  em_hit_plus_gtr100_ly.clear();
//  em_hit_plus_gtr100_xt.clear();
//  em_hit_plus_gtr100_yt.clear();
//  em_hit_plus_gtr100_xadc.clear();
//  em_hit_plus_gtr100_yadc.clear();
//  em_hit_plus_gtr100_xsize.clear();
//  em_hit_plus_gtr100_ysize.clear();
  em_hit_plus_gtr200_xid.clear();
  em_hit_plus_gtr200_yid.clear();
  em_hit_plus_gtr200_lx.clear();
  em_hit_plus_gtr200_ly.clear();
//  em_hit_plus_gtr200_xt.clear();
//  em_hit_plus_gtr200_yt.clear();
//  em_hit_plus_gtr200_xadc.clear();
//  em_hit_plus_gtr200_yadc.clear();
//  em_hit_plus_gtr200_xsize.clear();
//  em_hit_plus_gtr200_ysize.clear();
  em_hit_plus_gtr300_xid.clear();
  em_hit_plus_gtr300_yid.clear();
  em_hit_plus_gtr300_lx.clear();
  em_hit_plus_gtr300_ly.clear();
//  em_hit_plus_gtr300_xt.clear();
//  em_hit_plus_gtr300_yt.clear();
//  em_hit_plus_gtr300_xadc.clear();
//  em_hit_plus_gtr300_yadc.clear();
//  em_hit_plus_gtr300_xsize.clear();
//  em_hit_plus_gtr300_ysize.clear();
...
//  em_hit_minus_ssd_adc.clear();
//  em_hit_minus_ssd_size.clear();
  em_hit_minus_gtr100_xid.clear();
  em_hit_minus_gtr100_yid.clear();
  em_hit_minus_gtr100_lx.clear();
  em_hit_minus_gtr100_ly.clear();
//  em_hit_minus_gtr100_xt.clear();
//  em_hit_minus_gtr100_yt.clear();
//  em_hit_minus_gtr100_xadc.clear();
//  em_hit_minus_gtr100_yadc.clear();
//  em_hit_minus_gtr100_xsize.clear();
//  em_hit_minus_gtr100_ysize.clear();
  em_hit_minus_gtr200_xid.clear();
  em_hit_minus_gtr200_yid.clear();
  em_hit_minus_gtr200_lx.clear();
  em_hit_minus_gtr200_ly.clear();
//  em_hit_minus_gtr200_xt.clear();
//  em_hit_minus_gtr200_yt.clear();
//  em_hit_minus_gtr200_xadc.clear();
//  em_hit_minus_gtr200_yadc.clear();
//  em_hit_minus_gtr200_xsize.clear();
//  em_hit_minus_gtr200_ysize.clear();
  em_hit_minus_gtr300_xid.clear();
  em_hit_minus_gtr300_yid.clear();
  em_hit_minus_gtr300_lx.clear();
  em_hit_minus_gtr300_ly.clear();
//  em_hit_minus_gtr300_xt.clear();
//  em_hit_minus_gtr300_yt.clear();
//  em_hit_minus_gtr300_xadc.clear();
...
//  tree->Branch("res_minus_gtr300_ly",              &out_res_minus_gtr300_ly);
  ...
  em_res_plus_ssd_lx.clear();
  em_res_plus_gtr100_lx.clear();
  em_res_plus_gtr100_ly.clear();
  em_res_plus_gtr200_lx.clear();
  em_res_plus_gtr200_ly.clear();
  em_res_plus_gtr300_lx.clear();
  em_res_plus_gtr300_ly.clear();
  em_res_minus_ssd_lx.clear();
  em_res_minus_gtr100_lx.clear();
  em_res_minus_gtr100_ly.clear();
  em_res_minus_gtr200_lx.clear();
  em_res_minus_gtr200_ly.clear();
  em_res_minus_gtr300_lx.clear();
  em_res_minus_gtr300_ly.clear();
...
//  em_plus_n_pairs.emplace_back(n_pairs);
  ...
  em_hit_plus_gtr200_xid.emplace_back(rk_hit_gtr200_xid->at(plus_track_index));
  em_hit_plus_gtr200_yid.emplace_back(rk_hit_gtr200_yid->at(plus_track_index));
  em_hit_plus_gtr300_xid.emplace_back(rk_hit_gtr300_xid->at(plus_track_index));
  em_hit_plus_gtr300_yid.emplace_back(rk_hit_gtr300_yid->at(plus_track_index));
  em_hit_plus_ssd_lx.emplace_back(rk_hit_ssd_x->at(plus_track_index));
  em_hit_plus_gtr100_lx.emplace_back(rk_hit_gtr100_tx2->at(plus_track_index));
  em_hit_plus_gtr100_ly.emplace_back(rk_hit_gtr100_ty->at(plus_track_index));
  em_hit_plus_gtr200_lx.emplace_back(rk_hit_gtr200_tx2->at(plus_track_index));
  ...
  em_fit_plus_ssd_mom_lx.emplace_back(rk_fit_ssd_mom_x->at(plus_track_index));
  em_fit_plus_ssd_mom_ly.emplace_back(rk_fit_ssd_mom_y->at(plus_track_index));
  em_fit_plus_ssd_mom_lz.emplace_back(rk_fit_ssd_mom_z->at(plus_track_index));
  em_fit_plus_ssd_mom_gx.emplace_back(rk_fit_ssd_mom_gx->at(plus_track_index));
  em_fit_plus_ssd_mom_gy.emplace_back(rk_fit_ssd_mom_gy->at(plus_track_index));
  em_fit_plus_ssd_mom_gz.emplace_back(rk_fit_ssd_mom_gz->at(plus_track_index));
  em_fit_plus_gtr100_mom_lx.emplace_back(rk_fit_gtr100_mom_x->at(plus_track_index));
  em_fit_plus_gtr100_mom_ly.emplace_back(rk_fit_gtr100_mom_y->at(plus_track_index));
  em_fit_plus_gtr100_mom_lz.emplace_back(rk_fit_gtr100_mom_z->at(plus_track_index));
  em_fit_plus_gtr100_mom_gx.emplace_back(rk_fit_gtr100_mom_gx->at(plus_track_index));
  em_fit_plus_gtr100_mom_gy.emplace_back(rk_fit_gtr100_mom_gy->at(plus_track_index));
  em_fit_plus_gtr100_mom_gz.emplace_back(rk_fit_gtr100_mom_gz->at(plus_track_index));
  em_fit_plus_gtr200_mom_lx.emplace_back(rk_fit_gtr200_mom_x->at(plus_track_index));
  em_fit_plus_gtr200_mom_ly.emplace_back(rk_fit_gtr200_mom_y->at(plus_track_index));
  em_fit_plus_gtr200_mom_lz.emplace_back(rk_fit_gtr200_mom_z->at(plus_track_index));
  em_fit_plus_gtr200_mom_gx.emplace_back(rk_fit_gtr200_mom_gx->at(plus_track_index));
  em_fit_plus_gtr200_mom_gy.emplace_back(rk_fit_gtr200_mom_gy->at(plus_track_index));
  em_fit_plus_gtr200_mom_gz.emplace_back(rk_fit_gtr200_mom_gz->at(plus_track_index));
  em_fit_plus_gtr300_mom_lx.emplace_back(rk_fit_gtr300_mom_x->at(plus_track_index));
  em_fit_plus_gtr300_mom_ly.emplace_back(rk_fit_gtr300_mom_y->at(plus_track_index));
  em_fit_plus_gtr300_mom_lz.emplace_back(rk_fit_gtr300_mom_z->at(plus_track_index));
  em_fit_plus_gtr300_mom_gx.emplace_back(rk_fit_gtr300_mom_gx->at(plus_track_index));
  em_fit_plus_gtr300_mom_gy.emplace_back(rk_fit_gtr300_mom_gy->at(plus_track_index));
  em_fit_plus_gtr300_mom_gz.emplace_back(rk_fit_gtr300_mom_gz->at(plus_track_index));
  em_fit_plus_hbd_mom_lx.emplace_back(rk_fit_hbd_mom_x->at(plus_track_index));
  em_fit_plus_hbd_mom_ly.emplace_back(rk_fit_hbd_mom_y->at(plus_track_index));
  em_fit_plus_hbd_mom_lz.emplace_back(rk_fit_hbd_mom_z->at(plus_track_index));
  em_fit_plus_hbd_mom_gx.emplace_back(rk_fit_hbd_mom_gx->at(plus_track_index));
  em_fit_plus_hbd_mom_gy.emplace_back(rk_fit_hbd_mom_gy->at(plus_track_index));
  em_fit_plus_hbd_mom_gz.emplace_back(rk_fit_hbd_mom_gz->at(plus_track_index));
  em_fit_plus_lg_c_mom_lx.emplace_back(rk_fit_lg_c_mom_x->at(plus_track_index));
  em_fit_plus_lg_c_mom_ly.emplace_back(rk_fit_lg_c_mom_y->at(plus_track_index));
  em_fit_plus_lg_c_mom_lz.emplace_back(rk_fit_lg_c_mom_z->at(plus_track_index));
  em_fit_plus_lg_c_mom_gx.emplace_back(rk_fit_lg_c_mom_gx->at(plus_track_index));
  em_fit_plus_lg_c_mom_gy.emplace_back(rk_fit_lg_c_mom_gy->at(plus_track_index));
  em_fit_plus_lg_c_mom_gz.emplace_back(rk_fit_lg_c_mom_gz->at(plus_track_index));
  em_fit_plus_lg_b_mom_lx.emplace_back(rk_fit_lg_b_mom_x->at(plus_track_index));
  em_fit_plus_lg_b_mom_ly.emplace_back(rk_fit_lg_b_mom_y->at(plus_track_index));
  em_fit_plus_lg_b_mom_lz.emplace_back(rk_fit_lg_b_mom_z->at(plus_track_index));
  em_fit_plus_lg_b_mom_gx.emplace_back(rk_fit_lg_b_mom_gx->at(plus_track_index));
  em_fit_plus_lg_b_mom_gy.emplace_back(rk_fit_lg_b_mom_gy->at(plus_track_index));
  em_fit_plus_lg_b_mom_gz.emplace_back(rk_fit_lg_b_mom_gz->at(plus_track_index));
  em_fit_plus_lg_a_mom_lx.emplace_back(rk_fit_lg_a_mom_x->at(plus_track_index));
  em_fit_plus_lg_a_mom_ly.emplace_back(rk_fit_lg_a_mom_y->at(plus_track_index));
  em_fit_plus_lg_a_mom_lz.emplace_back(rk_fit_lg_a_mom_z->at(plus_track_index));
  em_fit_plus_lg_a_mom_gx.emplace_back(rk_fit_lg_a_mom_gx->at(plus_track_index));
  em_fit_plus_lg_a_mom_gy.emplace_back(rk_fit_lg_a_mom_gy->at(plus_track_index));
  em_fit_plus_lg_a_mom_gz.emplace_back(rk_fit_lg_a_mom_gz->at(plus_track_index));
  ...
  em_res_plus_ssd_lx.emplace_back(rk_res_ssd_x->at(plus_track_index));
  em_res_plus_gtr100_lx.emplace_back(rk_res_gtr100_tx2->at(plus_track_index));
  em_res_plus_gtr100_ly.emplace_back(rk_res_gtr100_ty->at(plus_track_index));
  em_res_plus_gtr200_lx.emplace_back(rk_res_gtr200_tx2->at(plus_track_index));
  em_res_plus_gtr200_ly.emplace_back(rk_res_gtr200_ty->at(plus_track_index));
  em_res_plus_gtr300_lx.emplace_back(rk_res_gtr300_tx2->at(plus_track_index));
  em_res_plus_gtr300_ly.emplace_back(rk_res_gtr300_ty->at(plus_track_index));
...
//  em_minus_n_pairs.emplace_back(n_pairs);
  ...
  em_fit_minus_ssd_mom_lx.emplace_back(rk_fit_ssd_mom_x->at(minus_track_index));
  em_fit_minus_ssd_mom_ly.emplace_back(rk_fit_ssd_mom_y->at(minus_track_index));
  em_fit_minus_ssd_mom_lz.emplace_back(rk_fit_ssd_mom_z->at(minus_track_index));
  em_fit_minus_ssd_mom_gx.emplace_back(rk_fit_ssd_mom_gx->at(minus_track_index));
  em_fit_minus_ssd_mom_gy.emplace_back(rk_fit_ssd_mom_gy->at(minus_track_index));
  em_fit_minus_ssd_mom_gz.emplace_back(rk_fit_ssd_mom_gz->at(minus_track_index));
  em_fit_minus_gtr100_mom_lx.emplace_back(rk_fit_gtr100_mom_x->at(minus_track_index));
  em_fit_minus_gtr100_mom_ly.emplace_back(rk_fit_gtr100_mom_y->at(minus_track_index));
  em_fit_minus_gtr100_mom_lz.emplace_back(rk_fit_gtr100_mom_z->at(minus_track_index));
  em_fit_minus_gtr100_mom_gx.emplace_back(rk_fit_gtr100_mom_gx->at(minus_track_index));
  em_fit_minus_gtr100_mom_gy.emplace_back(rk_fit_gtr100_mom_gy->at(minus_track_index));
  em_fit_minus_gtr100_mom_gz.emplace_back(rk_fit_gtr100_mom_gz->at(minus_track_index));
  em_fit_minus_gtr200_mom_lx.emplace_back(rk_fit_gtr200_mom_x->at(minus_track_index));
  em_fit_minus_gtr200_mom_ly.emplace_back(rk_fit_gtr200_mom_y->at(minus_track_index));
  em_fit_minus_gtr200_mom_lz.emplace_back(rk_fit_gtr200_mom_z->at(minus_track_index));
  em_fit_minus_gtr200_mom_gx.emplace_back(rk_fit_gtr200_mom_gx->at(minus_track_index));
  em_fit_minus_gtr200_mom_gy.emplace_back(rk_fit_gtr200_mom_gy->at(minus_track_index));
  em_fit_minus_gtr200_mom_gz.emplace_back(rk_fit_gtr200_mom_gz->at(minus_track_index));
  em_fit_minus_gtr300_mom_lx.emplace_back(rk_fit_gtr300_mom_x->at(minus_track_index));
  em_fit_minus_gtr300_mom_ly.emplace_back(rk_fit_gtr300_mom_y->at(minus_track_index));
  em_fit_minus_gtr300_mom_lz.emplace_back(rk_fit_gtr300_mom_z->at(minus_track_index));
  em_fit_minus_gtr300_mom_gx.emplace_back(rk_fit_gtr300_mom_gx->at(minus_track_index));
  em_fit_minus_gtr300_mom_gy.emplace_back(rk_fit_gtr300_mom_gy->at(minus_track_index));
  em_fit_minus_gtr300_mom_gz.emplace_back(rk_fit_gtr300_mom_gz->at(minus_track_index));
  em_fit_minus_hbd_mom_lx.emplace_back(rk_fit_hbd_mom_x->at(minus_track_index));
  em_fit_minus_hbd_mom_ly.emplace_back(rk_fit_hbd_mom_y->at(minus_track_index));
  em_fit_minus_hbd_mom_lz.emplace_back(rk_fit_hbd_mom_z->at(minus_track_index));
  em_fit_minus_hbd_mom_gx.emplace_back(rk_fit_hbd_mom_gx->at(minus_track_index));
  em_fit_minus_hbd_mom_gy.emplace_back(rk_fit_hbd_mom_gy->at(minus_track_index));
  em_fit_minus_hbd_mom_gz.emplace_back(rk_fit_hbd_mom_gz->at(minus_track_index));
  em_fit_minus_lg_c_mom_lx.emplace_back(rk_fit_lg_c_mom_x->at(minus_track_index));
  em_fit_minus_lg_c_mom_ly.emplace_back(rk_fit_lg_c_mom_y->at(minus_track_index));
  em_fit_minus_lg_c_mom_lz.emplace_back(rk_fit_lg_c_mom_z->at(minus_track_index));
  em_fit_minus_lg_c_mom_gx.emplace_back(rk_fit_lg_c_mom_gx->at(minus_track_index));
  em_fit_minus_lg_c_mom_gy.emplace_back(rk_fit_lg_c_mom_gy->at(minus_track_index));
  em_fit_minus_lg_c_mom_gz.emplace_back(rk_fit_lg_c_mom_gz->at(minus_track_index));
  em_fit_minus_lg_b_mom_lx.emplace_back(rk_fit_lg_b_mom_x->at(minus_track_index));
  em_fit_minus_lg_b_mom_ly.emplace_back(rk_fit_lg_b_mom_y->at(minus_track_index));
  em_fit_minus_lg_b_mom_lz.emplace_back(rk_fit_lg_b_mom_z->at(minus_track_index));
  em_fit_minus_lg_b_mom_gx.emplace_back(rk_fit_lg_b_mom_gx->at(minus_track_index));
  em_fit_minus_lg_b_mom_gy.emplace_back(rk_fit_lg_b_mom_gy->at(minus_track_index));
  em_fit_minus_lg_b_mom_gz.emplace_back(rk_fit_lg_b_mom_gz->at(minus_track_index));
  em_fit_minus_lg_a_mom_lx.emplace_back(rk_fit_lg_a_mom_x->at(minus_track_index));
  em_fit_minus_lg_a_mom_ly.emplace_back(rk_fit_lg_a_mom_y->at(minus_track_index));
  em_fit_minus_lg_a_mom_lz.emplace_back(rk_fit_lg_a_mom_z->at(minus_track_index));
  em_fit_minus_lg_a_mom_gx.emplace_back(rk_fit_lg_a_mom_gx->at(minus_track_index));
  em_fit_minus_lg_a_mom_gy.emplace_back(rk_fit_lg_a_mom_gy->at(minus_track_index));
  em_fit_minus_lg_a_mom_gz.emplace_back(rk_fit_lg_a_mom_gz->at(minus_track_index));
  ...
  em_res_minus_ssd_lx.emplace_back(rk_res_ssd_x->at(minus_track_index));
  em_res_minus_gtr100_lx.emplace_back(rk_res_gtr100_tx2->at(minus_track_index));
  em_res_minus_gtr100_ly.emplace_back(rk_res_gtr100_ty->at(minus_track_index));
  em_res_minus_gtr200_lx.emplace_back(rk_res_gtr200_tx2->at(minus_track_index));
  em_res_minus_gtr200_ly.emplace_back(rk_res_gtr200_ty->at(minus_track_index));
  em_res_minus_gtr300_lx.emplace_back(rk_res_gtr300_tx2->at(minus_track_index));
  em_res_minus_gtr300_ly.emplace_back(rk_res_gtr300_ty->at(minus_track_index));
