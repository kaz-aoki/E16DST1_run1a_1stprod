...
// Sun May  8 19:22:10 2022 by ROOT version 5.34/01
// from TTree tree/tree
// found on file: /ccj/w/data06a/E16/user/ymorino/2205/dst1/wogtr1.root
//////////////////////////////////////////////////////////

#ifndef run_EfficiencyCalc_h
#define run_EfficiencyCalc_h
...
public :
   ...
   run_EfficiencyCalc(TTree *tree=0);
   virtual ~run_EfficiencyCalc();
...
#ifdef run_EfficiencyCalc_cxx
run_EfficiencyCalc::run_EfficiencyCalc(TTree *tree) : fChain(0) 
{
...
run_EfficiencyCalc::~run_EfficiencyCalc()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t run_EfficiencyCalc::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t run_EfficiencyCalc::LoadTree(Long64_t entry)
{
...
void run_EfficiencyCalc::Init(TTree *tree)
{
...
Bool_t run_EfficiencyCalc::Notify()
{
...
void run_EfficiencyCalc::Show(Long64_t entry)
{
...
Int_t run_EfficiencyCalc::Cut(Long64_t entry)
{
...
#endif // #ifdef run_EfficiencyCalc_cxx
